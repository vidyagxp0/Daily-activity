...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('global_capa_grids', function (Blueprint $table) {
            $table->id();
            ...
            $table->longText('batch_desposition')->nullable();
            $table->longText('batch_status')->nullable();
    ...
    {
        Schema::dropIfExists('global_capa_grids');
    }
};
