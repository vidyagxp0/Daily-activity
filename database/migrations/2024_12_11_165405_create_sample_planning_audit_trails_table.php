...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('sample_planning_audit_trails', function (Blueprint $table) {
            $table->id();
            $table->integer('sample_planning_id')->nullable();
    ...
    {
        Schema::dropIfExists('sample_planning_audit_trails');
    }
};
