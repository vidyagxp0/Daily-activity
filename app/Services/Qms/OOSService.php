...
class OOSService
{
    ...
    public static function update_oss(Request $request, $id)
    {
        ...
        try {
            ...
            $oosAudit = OOS::find($id);

            
            if ($lastOosRecod->description_gi != $oosAudit->description_gi){
                // dd($lastOosRecod->description_gi);
                $history = new OosAuditTrial;
                $history->oos_id = $lastOosRecod->id;
                $history->activity_type = 'Short Description';
                $history->previous = $lastOosRecod->description_gi;
                $history->current = $oosAudit->description_gi;
            ...
            if ($lastOosRecod->initiator_Group != $oosAudit->initiator_Group){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->initiator_Group;
                $history->activity_type = 'initiator Group';
                $history->current = $oosAudit->initiator_Group;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->initiator_group_code != $oosAudit->initiator_group_code){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->initiator_group_code;
                $history->activity_type = 'Initiator Group Code';
                $history->current = $oosAudit->initiator_group_code;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->if_others_gi != $oosAudit->if_others_gi){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->if_others_gi;
                $history->activity_type = 'If Others';
                $history->current = $oosAudit->if_others_gi;
                $history->save();
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
            ...
            if ($lastOosRecod->is_repeat_gi != $oosAudit->is_repeat_gi){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->is_repeat_gi;
                $history->activity_type = 'Is Repeat';
                $history->current = $oosAudit->is_repeat_gi;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->nature_of_change_gi != $oosAudit->nature_of_change_gi){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->nature_of_change_gi;
                $history->activity_type = 'Nature Of Change';
                $history->current = $oosAudit->nature_of_change_gi;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->deviation_occured_on_gi != $oosAudit->deviation_occured_on_gi){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->deviation_occured_on_gi;
                $history->activity_type = 'Deviation Occured On';
                $history->current = $oosAudit->deviation_occured_on_gi;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->source_document_type_gi != $oosAudit->source_document_type_gi){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->source_document_type_gi;
                $history->activity_type = 'Source Document Type';
                $history->current = $oosAudit->source_document_type_gi;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->sample_type_gi != $oosAudit->sample_type_gi){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->sample_type_gi;
                $history->activity_type = 'Sample Type';
                $history->current = $oosAudit->sample_type_gi;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->product_material_name_gi != $oosAudit->product_material_name_gi){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->product_material_name_gi;
                $history->activity_type = 'Product / Material Name';
                $history->current = $oosAudit->product_material_name_gi;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->market_gi != $oosAudit->market_gi){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->market_gi;
                $history->activity_type = 'Market';
                $history->current = $oosAudit->market_gi;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->customer_gi != $oosAudit->customer_gi){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
            ...
            // TapII
            if ($lastOosRecod->Comments_plidata != $oosAudit->Comments_plidata){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->Comments_plidata;
                $history->activity_type = 'Comments Plidata';
                $history->current = $oosAudit->Comments_plidata;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->justify_if_no_field_alert_pli != $oosAudit->justify_if_no_field_alert_pli){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->justify_if_no_field_alert_pli;
                $history->activity_type = 'Justify If No Field Alert Pli';
                $history->current = $oosAudit->justify_if_no_field_alert_pli;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->justify_if_no_analyst_int_pli != $oosAudit->justify_if_no_analyst_int_pli){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->justify_if_no_analyst_int_pli;
                $history->activity_type = 'Justify if no Analyst Int';
                $history->current = $oosAudit->justify_if_no_analyst_int_pli;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->phase_i_investigation_pli != $oosAudit->phase_i_investigation_pli){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->phase_i_investigation_pli;
                $history->activity_type = 'Phase I Investigation';
                $history->current = $oosAudit->phase_i_investigation_pli;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->phase_i_investigation_ref_pli != $oosAudit->phase_i_investigation_ref_pli){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->phase_i_investigation_ref_pli;
                $history->activity_type = 'Phase I Investigation Ref';
                $history->current = $oosAudit->phase_i_investigation_ref_pli;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            // TapIV
            if ($lastOosRecod->summary_of_prelim_investiga_plic != $oosAudit->summary_of_prelim_investiga_plic){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->summary_of_prelim_investiga_plic;
                $history->activity_type = 'Summary of Preliminary Investigation';
                $history->current = $oosAudit->summary_of_prelim_investiga_plic;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->root_cause_identified_plic != $oosAudit->root_cause_identified_plic){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->root_cause_identified_plic;
                $history->activity_type = 'Root Cause Identified';
                $history->current = $oosAudit->root_cause_identified_plic;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->oos_category_root_cause_ident_plic != $oosAudit->oos_category_root_cause_ident_plic){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->oos_category_root_cause_ident_plic;
                $history->activity_type = 'OOS Category-Root Cause Ident';
                $history->current = $oosAudit->oos_category_root_cause_ident_plic;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->root_cause_details_plic != $oosAudit->root_cause_details_plic){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->root_cause_details_plic;
                $history->activity_type = 'OOS Category Others';
                $history->current = $oosAudit->root_cause_details_plic;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->oos_category_others_plic != $oosAudit->oos_category_others_plic){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->oos_category_others_plic;
                $history->activity_type = 'Root Cause Details';
                $history->current = $oosAudit->oos_category_others_plic;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->capa_required_plic != $oosAudit->capa_required_plic){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->capa_required_plic;
                $history->activity_type = 'CAPA Required';
                $history->current = $oosAudit->capa_required_plic;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->reference_capa_no_plic != $oosAudit->reference_capa_no_plic){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->reference_capa_no_plic;
                $history->activity_type = 'Reference CAPA No';
                $history->current = $oosAudit->reference_capa_no_plic;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->delay_justification_for_pi_plic != $oosAudit->delay_justification_for_pi_plic){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->delay_justification_for_pi_plic;
                $history->activity_type = 'Delay Justification for Preliminary Investigation';
                $history->current = $oosAudit->delay_justification_for_pi_plic;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            // TapV5
            if ($lastOosRecod->review_comments_plir != $oosAudit->review_comments_plir){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->review_comments_plir;                
                $history->activity_type = 'Review Comments';
                $history->current = $oosAudit->review_comments_plir;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->phase_ii_inv_required_plir != $oosAudit->phase_ii_inv_required_plir){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->phase_ii_inv_required_plir;
                $history->activity_type = 'Phase II Inv. Required';
                $history->current = $oosAudit->phase_ii_inv_required_plir;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            // TapVI6
            if ($lastOosRecod->qa_approver_comments_piii != $oosAudit->qa_approver_comments_piii){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->qa_approver_comments_piii;
                $history->activity_type = 'QA Approver Comments';
                $history->current = $oosAudit->qa_approver_comments_piii;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->manufact_invest_required_piii != $oosAudit->manufact_invest_required_piii){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->manufact_invest_required_piii;
                $history->activity_type = ' Manufacturing Invest. Type';
                $history->current = $oosAudit->manufact_invest_required_piii;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->manufacturing_invest_type_piii != $oosAudit->manufacturing_invest_type_piii){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->manufacturing_invest_type_piii;
                $history->activity_type = 'manufacturing_invest_type_piii';
                $history->current = $oosAudit->manufacturing_invest_type_piii;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->audit_comments_piii != $oosAudit->audit_comments_piii){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->audit_comments_piii;
                $history->activity_type = 'Audit Comments';
                $history->current = $oosAudit->audit_comments_piii;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->hypo_exp_required_piii != $oosAudit->hypo_exp_required_piii){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->hypo_exp_required_piii;
                $history->activity_type = 'Hypo/Exp. Required';
                $history->current = $oosAudit->hypo_exp_required_piii;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->hypo_exp_reference_piii != $oosAudit->hypo_exp_reference_piii){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->hypo_exp_reference_piii;
                $history->activity_type = 'Hypo/Exp. Reference';
                $history->current = $oosAudit->hypo_exp_reference_piii;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            // TapVIII8
            if ($lastOosRecod->summary_of_exp_hyp_piiqcr != $oosAudit->summary_of_exp_hyp_piiqcr){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->summary_of_exp_hyp_piiqcr;
                $history->activity_type = 'Summary of Exp./Hyp.';
                $history->current = $oosAudit->summary_of_exp_hyp_piiqcr;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->summary_mfg_investigation_piiqcr != $oosAudit->summary_mfg_investigation_piiqcr){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->summary_mfg_investigation_piiqcr;
                $history->activity_type = 'Summary Mfg. Investigation';
                $history->current = $oosAudit->summary_mfg_investigation_piiqcr;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->root_casue_identified_piiqcr != $oosAudit->root_casue_identified_piiqcr){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->root_casue_identified_piiqcr;
                $history->activity_type = 'Root Casue Identified';
                $history->current = $oosAudit->root_casue_identified_piiqcr;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->oos_category_reason_identified_piiqcr != $oosAudit->oos_category_reason_identified_piiqcr){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->oos_category_reason_identified_piiqcr;
                $history->activity_type = 'OOS Category-Reason identified';
                $history->current = $oosAudit->oos_category_reason_identified_piiqcr;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->others_oos_category_piiqcr != $oosAudit->others_oos_category_piiqcr){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->others_oos_category_piiqcr;
                $history->activity_type = 'Others (OOS category)';
                $history->current = $oosAudit->others_oos_category_piiqcr;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->nature_of_change_gi != $oosAudit->nature_of_change_gi){
                ...
                $history->previous = $lastOosRecod->nature_of_change_gi;
                $history->activity_type = 'Details of Root Cause';
                $history->current = $oosAudit->details_of_root_cause_piiqcr;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->impact_assessment_piiqcr != $oosAudit->impact_assessment_piiqcr){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->impact_assessment_piiqcr;
                $history->activity_type = 'Impact Assessment.';
                $history->current = $oosAudit->impact_assessment_piiqcr;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            // ======= Additional Testing Proposal ============
            if ($lastOosRecod->review_comment_atp != $oosAudit->review_comment_atp){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->review_comment_atp;
                $history->activity_type = 'Review Comment Atp.';
                $history->current = $oosAudit->review_comment_atp;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->additional_test_proposal_atp != $oosAudit->additional_test_proposal_atp){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->additional_test_proposal_atp;
                $history->activity_type = 'Additional Test Proposal Atp.';
                $history->current = $oosAudit->additional_test_proposal_atp;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->additional_test_reference_atp != $oosAudit->additional_test_reference_atp){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->additional_test_reference_atp;
                $history->activity_type = 'additional Test Reference Atp.';
                $history->current = $oosAudit->additional_test_reference_atp;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            // =============== OOS Conclusion  =====================
            if ($lastOosRecod->conclusion_comments_oosc != $oosAudit->conclusion_comments_oosc){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->conclusion_comments_oosc;
                $history->activity_type = 'Conclusion Comments.';
                $history->current = $oosAudit->conclusion_comments_oosc;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->specification_limit_oosc != $oosAudit->specification_limit_oosc){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->specification_limit_oosc;
                $history->activity_type = 'Specification Limit.';
                $history->current = $oosAudit->specification_limit_oosc;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->results_to_be_reported_oosc != $oosAudit->results_to_be_reported_oosc){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->results_to_be_reported_oosc;
                $history->activity_type = 'Results to be Reported.';
                $history->current = $oosAudit->results_to_be_reported_oosc;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->final_reportable_results_oosc != $oosAudit->final_reportable_results_oosc){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->final_reportable_results_oosc;
                $history->activity_type = 'Final Reportable Results.';
                $history->current = $oosAudit->final_reportable_results_oosc;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->justifi_for_averaging_results_oosc != $oosAudit->justifi_for_averaging_results_oosc){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->justifi_for_averaging_results_oosc;
                $history->activity_type = 'Justifi. for Averaging Results.';
                $history->current = $oosAudit->justifi_for_averaging_results_oosc;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->oos_stands_oosc != $oosAudit->oos_stands_oosc){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->oos_stands_oosc;
                $history->activity_type = 'OOS Stands.';
                $history->current = $oosAudit->oos_stands_oosc;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->reference_record != $oosAudit->reference_record){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->reference_record;
                $history->activity_type = 'CAPA Ref No.';
                $history->current = $oosAudit->reference_record;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->justify_if_capa_not_required_oosc != $oosAudit->justify_if_capa_not_required_oosc){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->justify_if_capa_not_required_oosc;
                $history->activity_type = 'Justify if CAPA not required.';
                $history->current = $oosAudit->justify_if_capa_not_required_oosc;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->action_plan_req_oosc != $oosAudit->action_plan_req_oosc){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->action_plan_req_oosc;
                $history->activity_type = 'Action Item Req.';
                $history->current = $oosAudit->action_plan_req_oosc;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->justification_for_delay_oosc != $oosAudit->justification_for_delay_oosc){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->justification_for_delay_oosc;
                $history->activity_type = ' Justification for Delay.';
                $history->current = $oosAudit->justification_for_delay_oosc;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            // ========= OOS Conclusion Review ==============
            if ($lastOosRecod->conclusion_review_comments_ocr != $oosAudit->conclusion_review_comments_ocr){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->conclusion_review_comments_ocr;                
                $history->activity_type = ' Conclusion Review Comments.';
                $history->current = $oosAudit->conclusion_review_comments_ocr;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->action_taken_on_affec_batch_ocr != $oosAudit->action_taken_on_affec_batch_ocr){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->action_taken_on_affec_batch_ocr;
                $history->activity_type = 'Action Taken on Affec.batch.';
                $history->current = $oosAudit->action_taken_on_affec_batch_ocr;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->capa_req_ocr != $oosAudit->capa_req_ocr){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->capa_req_ocr;
                $history->activity_type = 'CAPA Req.';
                $history->current = $oosAudit->capa_req_ocr;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->justify_if_no_risk_assessment_ocr != $oosAudit->justify_if_no_risk_assessment_ocr){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->justify_if_no_risk_assessment_ocr;
                $history->activity_type = 'Justify if No Risk Assessment';
                $history->current = $oosAudit->justify_if_no_risk_assessment_ocr;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->cq_approver != $oosAudit->cq_approver){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->cq_approver;
                $history->activity_type = 'CQ Approver';
                $history->current = $oosAudit->cq_approver;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            // =========== CQ Review Comments ==========
            if ($lastOosRecod->cq_review_comments_ocqr != $oosAudit->cq_review_comments_ocqr){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->cq_review_comments_ocqr;
                $history->activity_type = 'CQ Review comments';
                $history->current = $oosAudit->cq_review_comments_ocqr;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            //==========  Batch Disposition =============
            if ($lastOosRecod->oos_category_bd != $oosAudit->oos_category_bd) {
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->oos_category_bd;
                $history->activity_type = 'OOS Category';
                $history->current = $oosAudit->oos_category_bd;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->others_bd != $oosAudit->others_bd){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->others_bd;
                $history->activity_type = 'Other';
                $history->current = $oosAudit->others_bd;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->material_batch_release_bd != $oosAudit->material_batch_release_bd){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->material_batch_release_bd;
                $history->activity_type = 'Material batch release bd';
                $history->current = $oosAudit->material_batch_release_bd;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->other_action_bd != $oosAudit->other_action_bd){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->other_action_bd;
                $history->activity_type = 'Other Action bd';
                $history->current = $oosAudit->other_action_bd;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->other_parameters_results_bd != $oosAudit->other_parameters_results_bd){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->other_parameters_results_bd;
                $history->activity_type = 'Other Parameters Results';
                $history->current = $oosAudit->other_parameters_results_bd;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->trend_of_previous_batches_bd != $oosAudit->trend_of_previous_batches_bd){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->trend_of_previous_batches_bd;
                $history->activity_type = 'Trend of Previous Batches';
                $history->current = $oosAudit->trend_of_previous_batches_bd;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->stability_data_bd != $oosAudit->stability_data_bd){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->stability_data_bd;
                $history->activity_type = 'Stability Data';
                $history->current = $oosAudit->stability_data_bd;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->process_validation_data_bd != $oosAudit->process_validation_data_bd){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->process_validation_data_bd;
                $history->activity_type = 'Process Validation Data';
                $history->current = $oosAudit->process_validation_data_bd;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->method_validation_bd != $oosAudit->method_validation_bd){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->method_validation_bd;
                $history->activity_type = 'Method Validation';
                $history->current = $oosAudit->method_validation_bd;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->any_market_complaints_bd != $oosAudit->any_market_complaints_bd){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->any_market_complaints_bd;
                $history->activity_type = 'Any Market Complaints';
                $history->current = $oosAudit->any_market_complaints_bd;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->statistical_evaluation_bd != $oosAudit->statistical_evaluation_bd){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->statistical_evaluation_bd;
                $history->activity_type = 'Statistical Evaluation Bd';
                $history->current = $oosAudit->statistical_evaluation_bd;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->risk_analysis_disposition_bd != $oosAudit->risk_analysis_disposition_bd){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->risk_analysis_disposition_bd;
                $history->activity_type = 'Risk Analysis Disposition_bd';
                $history->current = $oosAudit->risk_analysis_disposition_bd;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->conclusion_bd != $oosAudit->conclusion_bd){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->conclusion_bd;
                $history->activity_type = 'Conclusion bd';
                $history->current = $oosAudit->conclusion_bd;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            if ($lastOosRecod->justify_for_delay_in_activity_bd != $oosAudit->justify_for_delay_in_activity_bd){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                ...
                $history->activity_type = 'Justify for delay in activity';
                $history->current = $oosAudit->justify_for_delay_in_activity_bd;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            // =============== QA Head/Designee Approval ==========
            if ($lastOosRecod->reopen_approval_comments_uaa != $oosAudit->reopen_approval_comments_uaa){
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = $lastOosRecod->reopen_approval_comments_uaa;
                $history->activity_type = 'Approval Comments ';
                $history->current = $oosAudit->reopen_approval_comments_uaa;
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
