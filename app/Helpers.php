...
class Helpers
{
    ...
    public static function formatDateTime($dateTime, $format = 'd-M-Y H:i') {
        // Check if $dateTime is not null or empty
        if (!$dateTime) {
            return '';
        }
    
        // Parse the datetime string using Carbon and return the formatted result
        try {
    ...
    public static function getLabTechnicianUserlist($division = null){
        if (!$division) {
            return DB::table('user_roles')->where(['q_m_s_roles_id' => '80'])->select(['user_id', DB::raw('MAX(q_m_s_divisions_id) as q_m_s_divisions_id')])->groupBy('user_id')->get();
        } else {
            return DB::table('user_roles')->where(['q_m_s_roles_id' => '80', 'q_m_s_divisions_id' => $division])->select('user_id')->distinct()->get();
        }
    }
    ...
    // static function getFullDivisionName($code)
    // {
    //     $full_division_name = '';

    //     switch ($code) {
    //         case 'ARD':
    //             $full_division_name = "Analytical Research & Development";
    //             break;
    //         case 'RSD':
    //             $full_division_name = "Reference Standard";
    //             break;
    //         case 'MIC':
    //             $full_division_name = "Microbiology";
    //             break;
    //         case 'BIO':
    //             $full_division_name = "Biologics";
    //             break;
    //         case 'PVP':
    //             $full_division_name = "PvPI";
    //             break;
    //         case 'QAL':
    //             $full_division_name = "Quality Assurance";
    //             break;
    //         case 'MVP':
    //             $full_division_name = "MvPI";
    //             break;
    //         case 'OTH':
    //             $full_division_name = "Others";
    //             break;
