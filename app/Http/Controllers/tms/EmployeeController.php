    ...
    public function createEmp()
{
    ...
    public function store(Request $request)
    {
        ...
        $employee->addressNew = $request->addressNew;
        $employee->streetNew = $request->streetNew;
        $employee->cityNew = $request->cityNew;
        $employee->stateNew = $request->stateNew;
        $employee->countryNew = $request->countryNew;
        $employee->zone = $request->zone;
        $employee->address_one = $request->address_one;
        $employee->street_one = $request->street_one;
        $employee->postal_code_one = $request->postal_code_one;
        $employee->postal_code_two = $request->postal_code_two;
        $employee->emp_job = $request->emp_job;
