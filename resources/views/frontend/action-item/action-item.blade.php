                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="group-input"> 
                                        ...
                                        @if (!empty($parent_id))
                                            <input disabled type="text" name="record_number" value="{{ Helpers::getDivisionName($parent_division_id) }}/AI/{{ date('Y') }}/{{ $record}}">
                                        @else
                                ...
                                <div class="col-lg-6">  
                                    <div class="group-input">
                                        ...
                                        @if (!empty($parent_id))
                                            <input disabled type="text" name="division_code" value="{{ Helpers::getDivisionName($parent_division_id) }}">
