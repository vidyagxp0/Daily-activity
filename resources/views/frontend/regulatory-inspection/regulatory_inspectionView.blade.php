...
@section('container')
    ...
    <script>
        function addAuditAgenda(tableId) {
            ...
            var userHtml = '<select name="auditee1[]"><option value="">-- Select --</option>';
            ...
            var userHtml = '<select name="auditor1[]"><option value="">-- Select --</option>';
            for (var i = 0; i < users.length; i++) {
                userHtml += '<option value="' + users[i].id + '">' + users[i].name + '</option>';
            }
            userHtml += '</select>';
            ...
            cell9.innerHTML = "<input type='text'name='remark1[]'>";
    ...
    ======================================= --}}
            ...
            <div id="change-control-fields">
                <div class="container-fluid">
                    ...
                    <form action="{{ route('regulatoryUpdate', $data->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div id="step-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <select name="Initiator_Group"
                                                    {{ $data->stage == 0 || $data->stage == 10 ? 'disabled' : '' }}
                                                    id="initiator_group">
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <input name="short_description" id="docname"
                                                    {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}
                                                    value="{{ $data->short_description }}" required type="text">
                                            </div>
                                                                ...
                                                                @foreach (unserialize($grid_data->area_of_audit) as $key => $temps)
                                                                    <tr>
                                                                        ...
                                                                        <td> <select id="select-state"
                                                                                placeholder="Select..."
                                                                                name="auditor1[]"{{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}>
                                                                                <option value="">-Select-</option>
                                                                                @foreach ($users as $value)
                                                                                    <option
                                                                                        {{ unserialize($grid_data->auditor1)[$key] ? (unserialize($grid_data->auditor1)[$key] == $value->id ? 'selected' : ' ') : '' }}
                                                                                        value="{{ $value->id }}">
                                                                                        {{ $value->name }}
                                                                                    </option>
                                                                                @endforeach
                                                                        ...
                                                                        <td> <select id="select-state"
                                                                                placeholder="Select..."
                                                                                name="auditee1[]"{{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}>
                                                                                <option value="">-Select-</option>
                                                                                @foreach ($users as $value)
                                                                                    <option
                                                                                        {{ unserialize($grid_data->auditee1)[$key] ? (unserialize($grid_data->auditee1)[$key] == $value->id ? 'selected' : ' ') : '' }}
                                                                                        value="{{ $value->id }}">
                                                                                        {{ $value->name }}
                                                                                    </option>
                                                                                @endforeach
                                                                        ...
                                                                        {{-- <td><input type="text"
                                                                                name="remark1[]"{{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ unserialize($grid_data->remark1)[$key] ? unserialize($grid_data->remark1)[$key] : '' }}">
                                                                        </td> --}}
                                                                        <td><input type="text" name="remark1[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ unserialize($grid_data->remark1)[$key] ?? '' }}">
                                                                        </td>
                                                                    </tr>
                                                                @endforeach
                                                            @endif
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <textarea class="tiny" name="External_Auditing_Agency"
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                <label
                                                    ...
                                                    Details</label>
                                                <textarea class="tiny" type="text" name="Supplier_Details"
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                <label for="Supplier/Vendor/Manufacturer Site">Supplier/Vendor/Manufacturer
                                                    Site</label>
                                                <textarea class="tiny" type="text" name="Supplier_Site"
                                                        ...
                                                        <tbody id="observationDetail">
                                                            @if ($sgrid->observation_detail)
                                                                @php
                                                                    ...
                                                                    $observationShortDesc = unserialize(
                                                                        $sgrid->observationShortDesc,
                                                                    );
                                                                    $observationDetail = unserialize(
                                                                        $sgrid->observation_detail,
                                                                    );
                                                                    $observationCategory = unserialize(
                                                                        $sgrid->observationCategory,
                                                                    );
                                                                    $observationSubCat = unserialize(
                                                                        $sgrid->observationSubCat,
                                                                    );
                                                                    $frequency = unserialize($sgrid->frequency);
                                                                    $auditingAgency = unserialize(
                                                                        $sgrid->auditingAgency,
                                                                    );
                                                                    $audittype = unserialize($sgrid->audittype);
                                                                    $auditStartDate = unserialize(
                                                                        $sgrid->auditStartDate,
                                                                    );
                                                                    $auditEndDate = unserialize($sgrid->auditEndDate);
                                                                    $auditor = unserialize($sgrid->auditor);
                                                                    $observation_category = unserialize(
                                                                        $sgrid->observation_category,
                                                                    );
                                                                    $observationType = unserialize(
                                                                        $sgrid->observationType,
                                                                    );
                                                                    $observationArea = unserialize(
                                                                        $sgrid->observationArea,
                                                                    );
                                                                    $observationAreaSubCat = unserialize(
                                                                        $sgrid->observationAreaSubCat,
                                                                    );
                                                                    $capaRequired = unserialize($sgrid->capaRequired);
                                                                    $capaOwner = unserialize($sgrid->capaOwner);
                                                                    $capaDescription = unserialize(
                                                                        $sgrid->capaDescription,
                                                                    );
                                                                    $capaDueDate = unserialize($sgrid->capaDueDate);
                                                                    $capaSatus = unserialize($sgrid->capaSatus);
                                                                    $delayJustification = unserialize(
                                                                        $sgrid->delayJustification,
                                                                    );
                                                                ...
                                                                @foreach ($observationDetail as $key => $tempData)
                                                                    <tr>
                                                                        <td>{{ $key + 1 }}</td>
                                                                        <td><input type="text" name="divisionCode[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($divisionCode[$key]) ? $divisionCode[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text" name="siteId[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($siteId[$key]) ? $siteId[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text" name="referenceNo[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($referenceNo[$key]) ? $referenceNo[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text"
                                                                                name="observationShortDesc[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($observationShortDesc[$key]) ? $observationShortDesc[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text"
                                                                                name="observation_detail[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($observationDetail[$key]) ? $observationDetail[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text"
                                                                                name="observationCategory[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($observationCategory[$key]) ? $observationCategory[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text"
                                                                                name="observationSubCat[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($observationSubCat[$key]) ? $observationSubCat[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text" name="frequency[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($frequency[$key]) ? $frequency[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text" name="auditingAgency[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($auditingAgency[$key]) ? $auditingAgency[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text" name="audittype[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($audittype[$key]) ? $audittype[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text" name="auditStartDate[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($auditStartDate[$key]) ? $auditStartDate[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text" name="auditEndDate[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($auditEndDate[$key]) ? $auditEndDate[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text" name="auditor[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($auditor[$key]) ? $auditor[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text"
                                                                                name="observation_category[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($observation_category[$key]) ? $observation_category[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text" name="observationType[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($observationType[$key]) ? $observationType[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text" name="observationArea[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($observationArea[$key]) ? $observationArea[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text"
                                                                                name="observationAreaSubCat[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($observationAreaSubCat[$key]) ? $observationAreaSubCat[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text" name="capaRequired[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($capaRequired[$key]) ? $capaRequired[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text" name="capaOwner[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($capaOwner[$key]) ? $capaOwner[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text" name="capaDescription[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($capaDescription[$key]) ? $capaDescription[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text" name="capaDueDate[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($capaDueDate[$key]) ? $capaDueDate[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text" name="capaSatus[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($capaSatus[$key]) ? $capaSatus[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text"
                                                                                name="delayJustification[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($delayJustification[$key]) ? $delayJustification[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text" name="delayCategory[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($delayCategory[$key]) ? $delayCategory[$key] : '' }}">
                                                                        </td>
                                                                        <td><input type="text" name="remarks[]"
                                                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                                value="{{ isset($remarks[$key]) ? $remarks[$key] : '' }}">
                                                                        </td>
