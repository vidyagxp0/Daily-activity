...
@section('container')
    ...
    <div id="change-control-fields">
        <div class="container-fluid">
            ...
            <form id="auditform" action="{{ route('regulatory_audit_store') }}" method="post"
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="Initiator_Group" id="initiator_group">
                                            ...
                                            <option value="QAB" @if (old('Initiator_Group', $data->Initiator_Group ?? '') == 'QAB') selected @endif>Quality
                                                Assurance Biopharma</option>
                                            <option value="CQC" @if (old('Initiator_Group', $data->Initiator_Group ?? '') == 'CQC') selected @endif>Central
                                            ...
                                            <option value="CS" @if (old('Initiator_Group', $data->Initiator_Group ?? '') == 'CS') selected @endif>Central
                                                Stores</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="external_agencies" id="supplier_agencies"
                                            onchange="toggleOthersField(this.value, 'external_agencies_req', 'others')">
                                            <option value="">-- Select --</option>
                                    ...
                                    <div class="group-input">
                                        ...
                                        <table class="table table-bordered" id="internalaudit">
                                            ...
                                            <tbody>
                                                ...
                                                <td><input type="time" name="scheduled_end_time[]"></td>
                                                <td> <select id="select-state" placeholder="Select..." name="auditor1[]">
                                                        <option value="">Select a value</option>
                                                        @foreach ($users as $data)
                                                ...
                                                <td><select id="select-state" placeholder="Select..." name="auditee1[]">
                                                        <option value="">Select a value</option>
                                                        @foreach ($users as $data)
                                                            <option value="{{ $data->id }}">{{ $data->name }}
                                                            </option>
                                        ...
                                        <table class="table table-bordered" id="onservation-field-table"
                                            ...
                                            <tbody id="observationDetail">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="divisionCode" name="divisionCode[]">
                                                    </td>
                                                    <td><input type="text" class="siteId" name="siteId[]"></td>
                                                    <td><input type="text" class="referenceNo" name="referenceNo[]">
                                                    </td>
                                                    <td><input type="text" class="obsevrationShortDesc"
                                                            name="obsevrationShortDesc[]"></td>
                                                    <td><input type="text" class="observation_detail"
                                                            name="observation_detail[]"></td>
                                                    <td><input type="text" class="observationCategory"
                                                            name="observationCategory[]"></td>
                                                    <td><input type="text" class="observationSubCat"
                                                            name="observationSubCat[]"></td>
                                                    <td><input type="text" class="frequency" name="frequency[]"></td>
                                                    <td><input type="text" class="auditingAgency"
                                                            name="auditingAgency[]"></td>
                                                    <td><input type="text" class="audittype" name="audittype[]"></td>
                                                    <td><input type="text" class="auditStartDate"
                                                            name="auditStartDate[]"></td>
                                                    <td><input type="text" class="auditEndDate" name="auditEndDate[]">
                                                    </td>
                                                    <td><input type="text" class="auditor" name="auditor[]"></td>
                                                    <td><input type="text" class="observation_category"
                                                            name="observation_category[]"></td>
                                                    <td><input type="text" class="observationType"
                                                            name="observationType[]"></td>
                                                    <td><input type="text" class="observationArea"
                                                            name="observationArea[]"></td>
                                                    <td><input type="text" class="observationAreaSubCat"
                                                            name="observationAreaSubCat[]"></td>
                                                    <td><input type="text" class="capaRequired" name="capaRequired[]">
                                                    </td>
                                                    <td><input type="text" class="capaOwner" name="capaOwner[]"></td>
                                                    <td><input type="text" class="capaDescription"
                                                            name="capaDescription[]"></td>
                                                    <td><input type="text" class="capaDueDate" name="capaDueDate[]">
                                                    </td>
                                                    <td><input type="text" class="capaSatus" name="capaSatus[]"></td>
                                                    <td><input type="text" class="delayJustification"
                                                            name="delayJustification[]"></td>
                                                    <td><input type="text" class="delayCategory"
                                                            name="delayCategory[]"></td>
                                                    <td><input type="text" class="remarks" name="remarks[]"></td>
                                                    <td><input type="text" readonly class="Action" name="Action[]">
                                                    </td>
                                                </tr>
