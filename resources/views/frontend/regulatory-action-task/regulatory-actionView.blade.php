        ...
        <div class="container-fluid">
            <div class="inner-block">
                ...
                <div class="slogan">
                    ...
                    {{ Helpers::getDivisionName($data->division_id) }} / Regulatory Change
                </div>
            </div>
        </div>
    </div>
...
{{-- {{ dd($data->stage);}} --}}
                        <button class="button_theme1"> <a class="text-white"
                                href="{{ route('RegulatoryActionAuditTrialShow', $data->id) }}"> Audit Trail </a> </button>
        ...
        <div id="change-control-fields">
            <div class="container-fluid">
                ...
                <form action="{{ url('rcms/regulatory-actionView', $data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                        ...
                        <div id="CCForm1" class="inner-block cctabcontent">
                            <div class="inner-block-content">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            ...
                                            <input disabled type="text" name="record_number"
                                                value="{{ Helpers::getDivisionName($data->division_id) }}/RC/{{ Helpers::year($data->created_at) }}/{{ $data->record }}">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            <label for="Related Records">Regulatory Change Related Records</label>
                                            <select {{ $data->stage == 0 || $data->stage == 3 ? 'disabled' : '' }} multiple id="related_records" name="related_records[]"
                                                ...
                                                @foreach ($old_record as $new)
                                                        <option value="{{ $new->id }}"{{ in_array($new->id, explode(',', $data->Reference_Recores1)) ? 'selected' : '' }}>
                                                            {{ Helpers::getDivisionName($new->division_id) }}/RC/{{ date('Y') }}/{{ Helpers::recordFormat($new->record) }}
                                                        </option>
                                                    @endforeach
                                                    @endif
                                            </select>
