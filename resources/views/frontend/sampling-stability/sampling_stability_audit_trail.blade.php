                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="buttons-new">
                            ...
                            <button class="button_theme1"><a class="text-white"
                                    href="{{ url('samplingstability-show/' . $document->id) }}"> Back
                                </a>
                            </button>
                                ...
                                <!-- <form action="" method="POST"> -->
                                    <form action="{{ route('store_audit_review', $document->id) }}" method="POST">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            {{--{{ $auditCollect ? 'disabled' : '' }}{{ $auditCollect ? $auditCollect->reviewer_comment : '' }}--}}
                                            <div class="group-input">
                    ...
                    <table>
                        <div class="heading">
                            ...
                            <div style="margin-bottom: 5px;  font-weight: bold;"> Originator
                                : {{ $document->originator_id ? $document->originator_id : '' }}</div>
