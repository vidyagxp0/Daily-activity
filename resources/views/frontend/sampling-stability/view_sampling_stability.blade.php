    ...
    <div class="form-field-head">
        <div class="division-bar">
            <strong>Site Division/Project</strong> :
                {{ Helpers::getDivisionName(session()->get('division')) }} / Sample Management
        </div>
    </div>
        ...
        <div class="inner-block state-block">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    @endphp
                        ...
                        <button class="button_theme1"> <a class="text-white" href="{{ url('rcms/stability-management-audit-trail', $data->id) }}"> Audit Trail </a> </button>
            ...
            <form id="auditform" class="mainform" action="{{ route('update-stability-management', $data->id) }}" method="post"
                            ...
                            <script>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <div class="relative-container">
                                            <textarea name="samplePreprationComment">{{ $data->samplePreprationComment }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <div class="relative-container">
                                            <textarea name="QA_reviewer_comment">{{ $data->QA_reviewer_comment }}</textarea>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="group-input">
                                    ...
                                    <div class="static">{{ $data->supervisor_review_complete_by }}</div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="group-input">
                                    <label for="Audit Mgr.more Info Reqd On">Supervisor Review Complete On</label>
                                    <div class="static">{{ $data->supervisor_review_complete_on }}</div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="group-input">
                                    <label for="Audit Schedule On">Supervisor Review Complete Comment</label>
                                    <div class="static">{{ $data->supervisor_review_complete_comment }}</div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="child-modal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ url('rcms/stability-management-child', $data->id) }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="rejection-modal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ url('rcms/stability-management-rejectStage', $data->id) }}" method="POST">
                    @csrf
                    <!-- Modal body -->
                    <div class="modal-body">
    ...
    <div class="modal fade" id="signature-modal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ url('rcms/stability-management-sendStage', $data->id) }}" method="POST">
                    @csrf
                    <!-- Modal body -->
                    <div class="modal-body">
                        <div class="mb-3 text-justify">
