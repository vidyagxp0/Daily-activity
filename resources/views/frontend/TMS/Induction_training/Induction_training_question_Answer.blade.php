...
<div class="quiz-container">
    ...
    @if ($inductiontrainingid->trainingAttempt == -1)
    ...
    @else
        ...
        <form action="{{ route('check_answer_induction') }}" method="POST" id="quizForm"> <!-- Change to your actual form action -->
            ...
            <input type="hidden"  name="trainingAttempt" value="{{ $inductiontrainingid->trainingAttempt }}">
            ...
            <input type="hidden"  name="documentNumber" value="{{ $inductiontrainingid->documentNumber }}">
