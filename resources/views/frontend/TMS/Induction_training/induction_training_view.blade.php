...
@section('container')
    ...
    <div id="change-control-fields">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex" style="gap:20px;">
                        ...
                        <button class="button_theme1">
                            <a class="text-white" href="{{ route('induction_audittrail', $inductionTraining->id) }}"><i class="fas fa-history"></i> Audit
                                Trail
                            </a>
                        </button>
                    ...
                    Answer Submit
                        ...
                        @elseif($inductionTraining->stage == 5)
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                <i class="fas fa-graduation-cap"></i> QA/CQA Head Approval Complete
                            </button>
                        @elseif($inductionTraining->stage == 6)
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                <i class="fas fa-paper-plane"></i> Send To OJT
                            </button>
        ...
        <div class="cctab">
            ...
            <button class="cctablinks" onclick="openCity(event, 'CCForm4')"><i class="fas fa-clipboard-check"></i> Evaluation</button>
            <button class="cctablinks" onclick="openCity(event, 'CCForm5')"><i class="fas fa-check-circle"></i> HR Head Approval</button>
            <button class="cctablinks" onclick="openCity(event, 'CCForm6')"><i class="fas fa-check-circle"></i> QA/CQA Head Approval</button>
            @if ($inductionTraining->stage >= 6)
                <button class="cctablinks" onclick="openCity(event, 'CCForm8')"><i class="fas fa-award"></i> Certificate</button>
            @endif
            <button class="cctablinks" onclick="openCity(event, 'CCForm7')"><i class="fas fa-user-tie"></i> In HR Final Review</button>


            <button class="cctablinks" onclick="openCity(event, 'CCForm9')"><i class="fas fa-briefcase"></i> On The Job Training</button>
            <button class="cctablinks" onclick="openCity(event, 'CCForm10')"><i class="fas fa-clipboard-list"></i> Activity Log</button>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="group-input">
                                    ...
                                    <input type="text" name="designation_visible" id="job_title"
                                    ...
                                    <div class="why-why-chart">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td style="background: #DCD8D8">Introduction of Organization Plant</td>
                                                            ...
                                                            <div class="group-input input-date">
                                                                <div class="calenderauditee">
                                                                    ...
                                                                    <input type="date" name="training_date_1"
                                                                        ...
                                                                        value="{{ $inductionTraining->training_date_1 }}"
                                                                        class="hide-input"
                                                            ...
                                                            <div class="group-input input-date">
                                                                <div class="calenderauditee">
                                                                    ...
                                                                    <input type="date" name="training_date_2"
                                                                        min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                                                        value="{{ $inductionTraining->training_date_2 }}"
                                                                        class="hide-input"
                                                            ...
                                                            <div class="group-input input-date">
                                                                <div class="calenderauditee">
                                                                    ...
                                                                    <input type="date" name="training_date_3"
                                                                        min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                                                        value="{{ $inductionTraining->training_date_3 }}"
                                                                        class="hide-input"
                                                            ...
                                                            <div class="group-input input-date">
                                                                <div class="calenderauditee">
                                                                    ...
                                                                    <input type="date" name="training_date_4"
                                                                        min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                                                        value="{{ $inductionTraining->training_date_4 }}"
                                                                        class="hide-input"
                                                            ...
                                                            <div class="group-input input-date">
                                                                <div class="calenderauditee">
                                                                    ...
                                                                    <input type="date" name="training_date_5"
                                                                        min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                                                        value="{{ $inductionTraining->training_date_5 }}"
                                                                        class="hide-input"
                                                            ...
                                                            <div class="group-input input-date">
                                                                <div class="calenderauditee">
                                                                    ...
                                                                    <input type="date" name="training_date_6"
                                                                        min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                                                        value="{{ $inductionTraining->training_date_6 }}"
                                                                        class="hide-input"
                                                            ...
                                                            <div class="group-input input-date">
                                                                <div class="calenderauditee">
                                                                    ...
                                                                    <input type="date" name="training_date_7"
                                                                        min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                                                        value="{{ $inductionTraining->training_date_7 }}"
                                                                        class="hide-input"
                                                            ...
                                                            <div class="group-input input-date">
                                                                <div class="calenderauditee">
                                                                    ...
                                                                    <input type="date" name="training_date_8"
                                                                        min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                                                        value="{{ $inductionTraining->training_date_8 }}"
                                                                        class="hide-input"
                                                            ...
                                                            <div class="group-input input-date">
                                                                <div class="calenderauditee">
                                                                    ...
                                                                    <input type="date" name="training_date_9"
                                                                        min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                                                        value="{{ $inductionTraining->training_date_9 }}"
                                                                        class="hide-input"
                                                            ...
                                                            <div class="group-input input-date">
                                                                <div class="calenderauditee">
                                                                    ...
                                                                    <input type="date" name="training_date_10"
                                                                        min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                                                        value="{{ $inductionTraining->training_date_10 }}"
                                                                        class="hide-input"
                                                            ...
                                                            <div class="group-input input-date">
                                                                <div class="calenderauditee">
                                                                    ...
                                                                    <input type="date" name="training_date_11"
                                                                        min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                                                        value="{{ $inductionTraining->training_date_11 }}"
                                                                        class="hide-input"
                                                            ...
                                                            <div class="group-input input-date">
                                                                <div class="calenderauditee">
                                                                    ...
                                                                    <input type="date" name="training_date_12"
                                                                        min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                                                        value="{{ $inductionTraining->training_date_12 }}"
                                                                        class="hide-input"
                                                            ...
                                                            <div class="group-input input-date">
                                                                <div class="calenderauditee">
                                                                    ...
                                                                    <input type="date" name="training_date_13"
                                                                        min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                                                        value="{{ $inductionTraining->training_date_13 }}"
                                                                        class="hide-input"
                                                            ...
                                                            <div class="group-input input-date">
                                                                <div class="calenderauditee">
                                                                    ...
                                                                    <input type="date" name="training_date_14"
                                                                        min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                                                        value="{{ $inductionTraining->training_date_14 }}"
                                                                        class="hide-input"
                                                            ...
                                                            <div class="group-input input-date">
                                                                <div class="calenderauditee">
                                                                    ...
                                                                    <input type="date" name="training_date_15"
                                                                        min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                                                        value="{{ $inductionTraining->training_date_15 }}"
                                                                        class="hide-input"
                            ...
                            <div class="col-lg-6">
                                <div class="group-input">
                                    ...
                                    <select id="training-select" name="training_type"
                                        onchange="">
                                        <option value="">Select</option>
                                        <option value="Self-Reading" @if ($inductionTraining->training_type == 'Self-Reading') selected @endif>
                                            Self-Reading</option>
                                        <option value="Read & Understand" @if ($inductionTraining->training_type == 'Read & Understand') selected @endif>
                                            Read & Understand</option>
                                        <option value="Read & Understand with Questions"
                                            @if ($inductionTraining->training_type == 'Read & Understand with Questions') selected @endif>Read & Understand with
                                            Questions
                                        </option>
                                        <option value="Classroom Training"
                                            @if ($inductionTraining->training_type == 'Classroom Training') selected @endif>Classroom Training</option>
                                        <option value="On Job Training" @if ($inductionTraining->training_type == 'On Job Training') selected @endif>
                                            On Job Training</option>
                                        <option value="External Training" @if ($inductionTraining->training_type == 'External Training') selected @endif>
                                            External Training
                                        </option>
                                        <option value="Refresher Training"
                                            @if ($inductionTraining->training_type == 'Refresher Training') selected @endif>Refresher Training</option>
                                        <option value="Retraining" @if ($inductionTraining->training_type == 'Retraining') selected @endif>
                                            Retraining</option>
                                        <option value="CBT" @if ($inductionTraining->training_type == 'CBT') selected @endif>
                            ...
                            <div class="col-6">
                                <div class="group-input">
                                    <label for="Total mininmum time">Minimum Sop View Time(in min)</label>
                                    <input type="number" name="total_minimum_time" id="total_minimum_time" min="0" value="{{ $inductionTraining->total_minimum_time }}">
                                </div>
                            </div>

                            <div class="col-6">
                                <div class="group-input">
                                    <label for="Total mininmum time">Maximum Sop View Time(in min)</label>
                                    <input type="number" name="per_screen_run_time" id="per_screen_run_time" min="0" value="{{ $inductionTraining->per_screen_run_time }}">
                                </div>
                            </div>
                                        ...
                                        <div class="pm-certificate-container">
                                            ...
                                            <div class="pm-certificate-border">
                                                ...
                                                <div class="pm-certificate-body">
                                                    <div class="pm-certificate-block" style="text-align: left;">
                                                        <p>
                                                            This is to certify that Mr. / Ms.
                                                            <strong>{{ \App\Models\Employee::find($inductionTraining->name_employee)?->employee_name ?? '_______________' }}</strong>
                                                            joined the organization on date <strong>{{ \App\Models\Employee::find($inductionTraining->name_employee)?->joining_date ? \Carbon\Carbon::parse(\App\Models\Employee::find($inductionTraining->name_employee)?->joining_date)->format('d-M-Y') : '_______________' }}</strong> was undergoing
                                                            induction training programme from date <strong>{{ \Carbon\Carbon::parse($inductionTraining->created_at)->format('d-M-Y h:i:s') ?? '_______________'}}</strong>.
                                                        </p>
                                                        @php
                                                           $inductionResult = DB::table('emp_training_quiz_results')->where(['training_id' => $inductionTraining->id, 'training_type' => "Induction Training", 'emp_id' => \App\Models\Employee::find($inductionTraining->name_employee)?->full_employee_id, 'result' => 'Pass'])->latest()->first();
                                                        @endphp
                                                        @php
                                                           $inductionResult = DB::table('emp_training_quiz_results')->where(['training_id' => $inductionTraining->id, 'training_type' => "Induction Training", 'emp_id' => \App\Models\Employee::find($inductionTraining->name_employee)?->full_employee_id, 'result' => 'Pass'])->latest()->first();
                                                        @endphp
                                                        <p>
                                                            The induction training programme is completed on
                                                            date <strong>{{ $inductionResult ? \Carbon\Carbon::parse($inductionResult->created_at)->format('d-M-Y h:i:s') : "______________" }}</strong> and the person is now being
                                                    ...
                                                    <div class="pm-certificate-footer">
                                                        <div class="pm-certified" style="text-align: left;">
                                                            ...
                                                            <span class="bold block"
                                                                style="display: block; margin-bottom: 5px; font-size: 14px;">
                                                                Employee Code:
                                                                <strong>{{ $inductionTraining->employee_id }}</strong>
                                                            </span>
                                                            <span class="bold block"
                                                                style="display: block; margin-bottom: 35px; font-size: 14px;">
                                                                Sign/Date:
                                                                {{ \App\Models\Employee::find($inductionTraining->name_employee)?->employee_name ?? 'Employee not found' }}
                                                                /
                                                                {{ \Carbon\Carbon::parse($inductionTraining->evaluation_complete_on)->format('d-M-Y') }}
                                                            </span>
                                                            <span class="bold block" style="font-size: 14px;">HR
                                                                Head/Designee (Sign & Date):</span>
                                                        </div>
                    ...
                    <form action="{{ route('induction.child', $inductionTraining->id) }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="group-input">
                                ...
                                <label style="display: flex;" for="major">
                                    <input type="radio" name="child_type" id="major" value="classroom_training">
                                    Classroom Training
                                </label>
                                <label style="display: flex;" for="major">
    ...
    <div class="modal fade" id="cancel-modal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ url('tms/induction/cancelstage', $inductionTraining->id) }}" method="POST" id="cancelstage">
                    @csrf
                    <!-- Modal body -->
                    <div class="modal-body">
                        <div class="mb-3 text-justify">
