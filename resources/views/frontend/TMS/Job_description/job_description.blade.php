...
<div id="change-control-fields">
    <div class="container-fluid">
        ...
        <!-- Tab links -->
        <div class="cctab">
            <button class="cctablinks active" onclick="openCity(event, 'CCForm1')"><i class="fas fa-briefcase"></i> Job Description</button>

            <button class="cctablinks " onclick="openCity(event, 'CCForm2')"><i class="fas fa-user-edit"></i> Employee Remarks</button>

            <button class="cctablinks " onclick="openCity(event, 'CCForm3')"><i class="fas fa-check-circle"></i> QA/CQA Approval</button>
            <button class="cctablinks " onclick="openCity(event, 'CCForm4')"><i class="fas fa-user-tie"></i> Responsible Person Accept Remarks</button>

            <button class="cctablinks " onclick="openCity(event, 'CCForm5')"><i class="fas fa-building"></i> Respected Department Remarks</button>
            <button class="cctablinks " onclick="openCity(event, 'CCForm6')"><i class="fas fa-id-card"></i> QA JD Number Remarks</button>
            <button class="cctablinks" onclick="openCity(event, 'CCForm7')"><i class="fas fa-calendar-check"></i> Activity Log</button>
        </div>
