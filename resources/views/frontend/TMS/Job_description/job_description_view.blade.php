...
@section('container')
    ...
    <div id="change-control-fields">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex" style="gap:20px;">
                        ...
                        <button class="button_theme1">
                            <a class="text-white" href="{{ route('auditTrail', $jobTraining->id) }}"><i class="fas fa-history"></i> Audit Trail
                            </a>
                        </button>
                        ...
                        @elseif($jobTraining->stage == 2)
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                <i class="fas fa-check-circle"></i> Accept JD Complete
                            </button>
                        ...
                        @elseif($jobTraining->stage == 5)
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                <i class="fas fa-paper-plane"></i> Send To QA
                            </button>
                        ...
                        @elseif($jobTraining->stage == 6)
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                <i class="fas fa-clipboard-check"></i> Closure
                            </button>
                        @endif
        ...
        <div class="cctab">
            ...
            <button class="cctablinks active"  onclick="openCity(event, 'CCForm2')"><i class="fas fa-briefcase"></i> Job Description</button>

            <button class="cctablinks " onclick="openCity(event, 'CCForm3')"><i class="fas fa-clipboard-check"></i> Employee Remarks</button>

            <button class="cctablinks " onclick="openCity(event, 'CCForm4')"><i class="fas fa-check-circle"></i> QA/CQA Approval</button>
            <button class="cctablinks " onclick="openCity(event, 'CCForm5')"><i class="fas fa-user-check"></i> Responsible Person Accept Remarks</button>
            ...
            @endif --}}
            <button class="cctablinks " onclick="openCity(event, 'CCForm6')"><i class="fas fa-users"></i> Respected Department Remarks</button>
            <button class="cctablinks " onclick="openCity(event, 'CCForm7')"> <i class="fas fa-id-badge"></i> QA JD Number Remarks</button>
            <button class="cctablinks " onclick="openCity(event, 'CCForm8')"><i class="fas fa-clipboard-list"></i> Activity Log</button>
