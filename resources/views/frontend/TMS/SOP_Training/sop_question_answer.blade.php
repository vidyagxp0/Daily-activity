...
<div class="quiz-container">
    ...
    @else
        ...
        <h1>SOP Training Quiz</h1>

        <form action="{{ route('check_answer_sop') }}" method="POST" id="quizForm">
            @csrf
            <input type="hidden" name="training_id" value="{{ $sopid->id }}">
            <input type="hidden" name="emp_id" value="{{ Auth::guard('employee')->user()->full_employee_id }}">
            <input type="hidden" name="employee_name" value="{{ Auth::guard('employee')->user()->employee_name }}">
            <input type="hidden" name="training_type" value="SOP Training">
            <input type="hidden" name="attempt_count" value="{{ $sopid->attempt_count }}">
