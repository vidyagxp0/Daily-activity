                    ...
                    <table>
                        <div class="buttons-new">
                            ...
                            <button class="button_theme1"><a class="text-white"
                                    href="{{ url('TMM_view/' . $document->id) }}"> Back </a>
                            </button>

                            <a class="text-white" href="{{ url('TMS') }}"> <button class="button_theme1">
                                    Exit
                            </a> </button>
                        ...
                        <div class="heading">
                            ...
                            <div> <strong>Record ID.</strong> {{ str_pad($document->id, 4, '0', STR_PAD_LEFT) }}
                            </div>
