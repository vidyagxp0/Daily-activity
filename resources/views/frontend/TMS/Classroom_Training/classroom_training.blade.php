...
<div id="change-control-fields">
    <div class="container-fluid">
        ...
        <form action="{{ route('classroom_trainingcreate') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div id="step-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="group-input">
                                    ...
                                    <input id="selected_employee_id" type="text" value="{{ $mainvalue->employee_name}}"
                                        name="name" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="group-input">
                                    ...
                                    <input type="text" name="employee_id" value="{{$mainvalue->full_employee_id}}"
                            ...
                            <div class="col-lg-6">
                                <div class="group-input">
                                    ...
                                    <input type="text" name="department"
                                        value="{{ Helpers::getDepartments()[$mainvalue->department]}}" id="department"
                                        readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="group-input">
                                    <label for="designation">Designation</label>
                                    <input type="text" name="designation" value="{{ $mainvalue->job_title }}"
                                        id="designee" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="group-input">
                                    ...
                                    <select name="revision_purpose" id="revision_purpose"
                                        onchange="toggleRemarkInput()">
                            ...
                            {{-- <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="evaluation_required">
                                            <option value="">----Select---</option>
                            ...
                            <div class="col-lg-6">
                                <div class="group-input">
                                    ...
                                    <input type="number" min="0" name="per_screen_running_time" id="">
                                </div>
                            </div>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select id="training-select" name="type_of_training_1" >
                                                            <option value="">---</option>
                                                    ...
                                                    <td><input type="text" name="reference_document_no_1_display"
                                                            id="document_number" readonly></td>

                                                    <input type="hidden" name="reference_document_no_1"
                                                        id="reference_document_no_1">
                                                    ...
                                                    <td>
                                                        <a href="" id="view_sop" target="_blank"
                                                            style="display:none;">View SOP</a>
                                                    </td>
                                                    <td>
                                                ...
                                                <input type="hidden" id="selected_document_id"
                                                ...
                                                <tr>
                                                    <td>2</td>
                                                    <td>
                                                        <select name="subject_2" id="sopdocument"
                                                            onchange="fetchDocumentDetails2(this)">
                                                            <option value="">---Select Document Name---</option>
                                                            @foreach ($data as $dat)
                                                                <option value="{{ $dat->document_name }}"
                                                                                                                    data-doc-number="{{ $dat->sop_type_short }}/{{ $dat->department_id }}/000{{ $dat->id }}/R{{ $dat->major }}"
                                                    ...
                                                    <td>
                                                        <select id="training-select" name="type_of_training_2" >
                                                            <option value="">---</option>
                                                            <option value="Read & Understand">Read & Understand</option>
                                                            <option value="Read & Understand with Questions">Read & Understand with Questions
                                                            </option>
                                                    ...
                                                    <td><input type="text" name="reference_document_no_2_display"
                                                            id="document_number2" readonly></td>

                                                    <input type="hidden" name="reference_document_no_2"
                                                        id="reference_document_no_2">
                                                    <td>
                                                    ...
                                                    <td>
                                                        <a href="" id="view_sop2" target="_blank"
                                                            style="display:none;">View SOP</a>
                                                    </td>
                                                    <td>
                                                        <label for="Attached "></label>
                                                ...
                                                <tr>
                                                    <td>3</td>
                                                    <td>
                                                        <select name="subject_3" id="sopdocument"
                                                            onchange="fetchDocumentDetails3(this)">
                                                            <option value="">---Select Document Name---</option>
                                                            @foreach ($data as $dat)
                                                                <option value="{{ $dat->document_name }}"
                                                                                                                    data-doc-number="{{ $dat->sop_type_short }}/{{ $dat->department_id }}/000{{ $dat->id }}/R{{ $dat->major }}"
                                                    ...
                                                    <td>
                                                        <select id="training-select" name="type_of_training_3">
                                                            <option value="">---</option>
                                                            <option value="Read & Understand">Read & Understand</option>
                                                            <option value="Read & Understand with Questions">Read & Understand with Questions
                                                            </option>
                                                    ...
                                                    <td><input type="text" name="reference_document_no_3_display"
                                                            id="document_number3" readonly></td>
                                                    <input type="hidden" name="reference_document_no_3"
                                                        id="reference_document_no_3">
                                                    ...
                                                    <td>
                                                        <a href="" id="view_sop3" target="_blank"
                                                            style="display:none;">View SOP</a>
                                                    </td>
                                                    <td>
                                                        <label for="Attached "></label>
                                                ...
                                                <inputype="hidden" id="selected_document_id3"
                                                    name="selected_document_id">
                                                ...
                                                <tr>
                                                    <td>4</td>
                                                    <td>
                                                        <select name="subject_4" id="sopdocument"
                                                            onchange="fetchDocumentDetails4(this)">
                                                            <option value="">---Select Document Name---</option>
                                                            @foreach ($data as $dat)
                                                                <option value="{{ $dat->document_name }}"
                                                                                                                    data-doc-number="{{ $dat->sop_type_short }}/{{ $dat->department_id }}/000{{ $dat->id }}/R{{ $dat->major }}"
                                                    ...
                                                    <td>
                                                        <select id="training-select" name="type_of_training_4">
                                                            <option value="">---</option>
                                                            <option value="Read & Understand">Read & Understand</option>
                                                            <option value="Read & Understand with Questions">Read & Understand with Questions
                                                            </option>
                                                    ...
                                                    <td><input type="text" name="reference_document_no_4_display"
                                                            id="document_number4" readonly></td>
                                                    <input type="hidden" name="reference_document_no_4"
                                                        id="reference_document_no_4">
                                                    ...
                                                    <td>
                                                        <a href="" id="view_sop4" target="_blank"
                                                            style="display:none;">View SOP</a>
                                                    </td>
                                                    <td>
                                                        <label for="Attached "></label>
                                                ...
                                                <inputype="hidden" id="selected_document_id4"
                                                    name="selected_document_id">
                                                ...
                                                <tr>
                                                    <td>5</td>
                                                    <td>
                                                        <select name="subject_5" id="sopdocument"
                                                            onchange="fetchDocumentDetails5(this)">
                                                            <option value="">---Select Document Name---</option>
                                                            @foreach ($data as $dat)
                                                                <option value="{{ $dat->document_name }}"
                                                                                                                    data-doc-number="{{ $dat->sop_type_short }}/{{ $dat->department_id }}/000{{ $dat->id }}/R{{ $dat->major }}"
                                                    ...
                                                    <td>
                                                        <select id="training-select" name="type_of_training_5">
                                                            <option value="">---</option>
                                                            <option value="Read & Understand">Read & Understand</option>
                                                            <option value="Read & Understand with Questions">Read & Understand with Questions
                                                            </option>
                                                    ...
                                                    <td><input type="text" name="reference_document_no_5_display"
                                                            id="document_number5" readonly></td>
                                                    <input type="hidden" name="reference_document_no_5"
                                                        id="reference_document_no_5">
                                                    ...
                                                    <td>
                                                        <a href="" id="view_sop5" target="_blank"
                                                            style="display:none;">View SOP</a>
                                                    </td>
                                                    <td>
                                                        <label for="Attached "></label>
                                                ...
                                                <input type="hidden" id="selected_document_id5"
                                                    name="selected_document_id">
                                            </tbody>
                                        </table>
                            ...
                            <div class="col-lg-12" id="remark_container">
                                <div class="group-input">
                ...
                <!-- <div id="CCForm2" class="inner-block cctabcontent">
                    <div class="inner-block-content">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="group-input">
                                    <label for="For Revision">Experience With Organization Pharma </label>
