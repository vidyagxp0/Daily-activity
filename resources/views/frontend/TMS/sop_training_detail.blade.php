...
<script>
    ...
    window.onload = function() {
        ...
        counterInterval = setInterval(function() {
            ...
            document.getElementById("readingTimeDisplay").textContent = hours + ':' + minutes + ':' + seconds;
            ...
            if (counterValue % 5 === 0) {
                saveReadingTime(); // Save every 5 seconds
            }
    ...
    function saveReadingTime() {
        fetch('{{ url('save-sop-reading-time') }}', {
            method: 'POST',
            headers: {
