...
@section('container')
    ...
    <div id="change-control-fields">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex" style="gap:20px;">
                        ...
                        <button class="button_theme1">
                            <a class="text-white" href="{{ route('job_audittrail', $jobTraining->id) }}"><i class="fas fa-history"></i> Audit Trail
                            </a>
                        </button>
                        ...
                        @elseif($jobTraining->stage == 5)
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                <i class="fas fa-graduation-cap"></i> QA/CQA Head Review Complete
                            </button>
                        @elseif($jobTraining->stage == 6)
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                <i class="fas fa-check-double"></i> Verification and Approval Complete
                            </button>
                        @endif
                        <button class="button_theme1"> 
        ...
        <div class="cctab">
            ...
            <button class="cctablinks " onclick="openCity(event, 'CCForm3')"><i class="fas fa-clipboard-check"></i> Evaluation</button>
                ...
                <div id="CCForm1" class="inner-block cctabcontent">
                    <div class="inner-block-content">
                        <div class="row">
                            <div class="row">
                                <div class="sub-head">
                                <i class="fas fa-info-circle"></i> Job Training Information
                            </div>
                                <div class="col-lg-6">
                            ...
                            <script>
                                ...
                                <div class="group-input">
                                    ...
                                    <input type="number" min="0" name="total_minimum_time" id="" value="{{ $jobTraining->total_minimum_time }}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="group-input">
                                    <label for="evaluation">Maximum Sop View Time(in min)</label>
                                    <input type="number" min="0" name="per_screen_running_time" id="" value="{{$jobTraining->per_screen_running_time}}">
                                </div>
                            </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="file" id="myfile" name="supporting_attachments1"
                                                            value="{{ $jobTraining->supporting_attachments1 }}">
                                                        <a href="{{ asset('upload/' . $jobTraining->supporting_attachments1) }}"
                                                            target="_blank">{{ $jobTraining->supporting_attachments1 }}</a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="file" id="myfile" name="supporting_attachments2"
                                                            value="{{ $jobTraining->supporting_attachments2 }}">
                                                        <a href="{{ asset('upload/' . $jobTraining->supporting_attachments2) }}"
                                                            target="_blank">{{ $jobTraining->supporting_attachments2 }}</a>
                                                    </td>
                                                    </tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="file" id="myfile" name="supporting_attachments3"
                                                            value="{{ $jobTraining->supporting_attachments3 }}">
                                                        <a href="{{ asset('upload/' . $jobTraining->supporting_attachments3) }}"
                                                            target="_blank">{{ $jobTraining->supporting_attachments3 }}</a>
                                                    </td>
                                                    </tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="file" id="myfile" name="supporting_attachments4"
                                                            value="{{ $jobTraining->supporting_attachments4 }}">
                                                        <a href="{{ asset('upload/' . $jobTraining->supporting_attachments4) }}"
                                                            target="_blank">{{ $jobTraining->supporting_attachments4 }}</a>
                                                    </td>
                                                    </tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="file" id="myfile" name="supporting_attachments5"
                                                            value="{{ $jobTraining->supporting_attachments5 }}">
                                                        <a href="{{ asset('upload/' . $jobTraining->supporting_attachments5) }}"
                                                            target="_blank">{{ $jobTraining->supporting_attachments5 }}</a>
                                                    </td>
                                                    </tr>
    ...
    <div class="modal fade" id="cancel-modal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ url('tms/jobTraining/cancelstage', $jobTraining->id) }}" method="POST" id="cancelstage">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3 text-justify">
                            Please select a meaning and a outcome for this task and enter your username
