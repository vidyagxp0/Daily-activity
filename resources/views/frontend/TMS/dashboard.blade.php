                        ...
                        <div class="modal-body">
                            <div class="group-input">
                                <label style="display: flex;" for="major">
                                    ...
                                    <a href="{{ route('employee_new') }}">Employee</a>
                                </label>
                                <label style="display: flex;" for="major">
                                    <input type="radio" name="child_type" id="major" value="">
                                    <a href="{{ url('training-module-management') }}">Training Module Management </a>
                                </label>
                                <label style="display: flex;" for="major">
                                    <input type="radio" name="child_type" id="major" value="">
                                    <a href="{{ route('create-tni') }}">Training Need Identification (Matrix) </a>
                                </label>
                                <label style="display: flex;" for="major">
                                    <input type="radio" name="child_type" id="major" value="">
                                    <a href="{{ route('tniemployee_create') }}">Training Need Identification (Employee) </a>
                                </label>
                                <label style="display: flex;" for="major">
                                    <input type="radio" name="child_type" id="major" value="">
                                ...
                                <label style="display: flex;" for="major">
                                    <input type="radio" name="child_type" id="major" value="">
                                    <a href="{{ route('TMS.create') }}">Training Plan</a>
                                </label>
                                <label style="display: flex;" for="major">
                                    <input type="radio" name="child_type" id="major" value="">
                                    <a href="{{ url('yearly_trainning_plan_create') }}">Yearly Training Planner</a>
                                </label>
                                
                                <label style="display: flex;" for="major">
                                    <input type="radio" name="child_type" id="major" value="">
                                    <a href="{{ route('department-wise-employee') }}">Department Wise Employees Job Role</a>
                                </label>
                        ...
                        <div class="modal-container">
                            ...
                            <div class="modal-body">
                                <div class="button-group">
                                    <a href="{{ route('employee_new') }}" class="action-button">
                                        <i class="fas fa-user"></i> Employee
                                    </a>
                                    <a href="{{ url('training-module-management') }}" class="action-button">
                                        <i class="fas fa-cogs"></i> Training Module Management
                                    </a>
                                    <a href="{{ route('create-tni') }}" class="action-button">
                                        <i class="fas fa-project-diagram"></i> Training Need Identification (Matrix)
                                    </a>
                                    <a href="{{ route('tniemployee_create') }}" class="action-button">
                                        <i class="fas fa-users"></i> Training Need Identification (Employee)
                                    </a>
                                    <a href="{{ route('trainer_qualification') }}" class="action-button">
                                        <i class="fas fa-chalkboard-teacher"></i> Trainer Qualification
                                    </a>
                                    <a href="{{ route('TMS.create') }}" class="action-button">
                                        <i class="fas fa-calendar-check"></i> Training Plan
                                    </a>
                                    <a href="{{ url('yearly_trainning_plan_create') }}" class="action-button">
                                        <i class="fas fa-calendar-alt"></i> Yearly Training Planner
                                    </a>
                                    <a href="{{ route('department-wise-employee') }}" class="action-button">
                                        <i class="fas fa-building"></i> Department Wise Employees Job Role
                                    </a>
                                </div>
                            </div>
                        </div>
    ...
    <div id="tms-dashboard">
        <div class="container-fluid">
            <div class="dashboard-container">
                ...
                <div class="inner-block main-block">
                    <div class="top">
                        ...
                        <div class="doc-links d-flex">
                            ...
                            <a class="btn btn-custom" data-bs-toggle="modal" data-bs-target="#child-modal">
                                + Create
                            </a>
                ...
                <div class="cctab" style="    margin-bottom: 5px !important;">
                    <button class="cctablinks active" onclick="openCity(event, 'CCForm3')">Employee</button>
                        ...
                        <button class="cctablinks " onclick="openCity(event, 'CCFormClass')">Classroom Training</button>
                        ...
                        {{-- <button class="cctablinks " onclick="openCity(event, 'CCForm10')">Analyst Qualification</button> --}}
                        <button class="cctablinks " onclick="openCity(event, 'CCForm11')">TNI Employee</button>
                        <button class="cctablinks " onclick="openCity(event, 'CCForm1')">My Created Training</button>
                        <button class="cctablinks " onclick="openCity(event, 'assigned')">Assigned To Me</button>
                        <style>
                        .cctab {
                        display: flex;
                        flex-wrap: wrap;
                ...
                <div class="cctab">
                    ...
                    <button class="cctablinks " onclick="openCity(event, 'CCForm9')">TMM</button>

                     <button class="cctablinks " onclick="openCity(event, 'CCForm8')">TNI Matrix</button>
                        
                    @endif
                    {{-- @if (Helpers::checkRoles(1) ||
                            Helpers::checkRoles(2) ||
                            Helpers::checkRoles(3) ||
                            Helpers::checkRoles(4) ||
                            Helpers::checkRoles(5) ||
                            Helpers::checkRoles(7) ||
                            Helpers::checkRoles(8))
                        <button class="cctablinks" onclick="openCity(event, 'CCForm2')">Assigned To Me</button>
                    @endif --}}
                    <button class="cctablinks" onclick="openCity(event, 'CCForm12')">Department Wise Employees</button>
                    <button class="cctablinks" onclick="openCity(event, 'CCForm13')">Yearly Training Planner</button>
                    <button class="cctablinks" onclick="openCity(event, 'CCForm14')">Scorm</button>
                                ...
                                @endphp --}}
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="view-report-btn"
                                            onclick="window.location.href='{{ url('rcms/reports/' . $employee->id) }}'">
                    ...
                    @if (Helpers::checkRoles(6))
                        <div>
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    @foreach ($documents->sortByDesc('id') as $index => $temp)
                                        @if (!empty($temp->training))
                                            <tr>
                                                @php
                                                    $trainingPlan = DB::table('trainings')
                                                        ->where('id', $temp->training_plan)
                                                        ->first();
                                                    if ($trainingPlan) {
                                                        $traineesCount = count(explode(',', $trainingPlan->employee_name));
                                                        $sopsCount = count(explode(',', $trainingPlan->sops));
                                                    }
                                                @endphp
                                                @if ($trainingPlan)
                                                 <td>{{$index + 1 }}</td>
                                                    <td>{{ DB::table('trainings')->where('id', $temp->training_plan)->value('traning_plan_name') }}
                                                    </td>
                                ...
                                000{{ $temp->root_document ? $temp->root_document->document_number : '' }}/{{ $temp->year }}/R{{$temp->major}}.{{$temp->minor}}</td> --}}
                                                ...
                                                <a href="#"><i class="fa-solid fa-eye"></i></a>
                                                    ...
                                                    <td><a
                                                            href="{{ url('training-overall-status', $temp->training_plan) }}"><i
    ...
    @endforeach
                        ...
                        <div>
                            <table class="table table-bordered">
                                ...
                                <tbody id="searchTable">
                                    @foreach ($paginatedData->sortByDesc('id')  as $index => $temp)
                                        @php
                                            $trainingStatusCheck = DB::table('training_statuses')
                                                ->where([
                                                    'user_id' => Auth::user()->id,
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $temp->traningstatus->status }}</td>
                                            <td>{{ \Carbon\Carbon::parse($trainingPlanName->training_end_date) }}</td>
                                            <td>{{ $trainingStatusCheck ? \Carbon\Carbon::parse($trainingStatusCheck->created_at)->format('d M Y') : '-' }}
                                            </td>
                                            @if ($trainingStatusCheck)
                                                <th>Completed</th>
                                            @else
                                ...
                                <tbody>
                                    {{-- @foreach ($trainers->sortbyDesc('id') as $index => $trainer)
                                        <tr>
                                            ...
                                            <td> <button type="button" class="view-report-btn"
                                                    onclick="window.location.href='{{ url('rcms/trainer_report/' . $trainer->id) }}'">
                                                    <i class="fa fa-file-alt"></i>
                                                </button></td>
                                        </tr>
                                    @endforeach --}}
...
{{-- 
                <div id="CCForm10" class="inner-block tms-block cctabcontent" style="margin-top:50px;">
                    <div>
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                ...
                                @foreach ($trainers->sortbyDesc('id') as $index => $trainer)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                         <td><a href="{{ url('trainer_qualification_view', $trainer->id) }}"><i class="fa-solid fa-pencil" style="color: #355cab;"></i></a></td> 
                                        <td>{{ $trainer->employee_name }}</td>
                                        <td>{{ Helpers::getFullDepartmentName($trainer->department) ? Helpers::getFullDepartmentName($trainer->department) : 'NA' }}
                                        </td>
                                        <td>{{ Helpers::getdateFormat($trainer->training_date) }}</td>
                                        <td>{{ $trainer->status }}</td>
                                        <td><a href="{{ url('trainer_qualification_view', $trainer->id) }}"><i
                ...
                <!-- //ccform11 -->
                <div id="CCForm11" class="inner-block tms-block cctabcontent" style="margin-top:50px;">
                    <div>
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                @foreach ($tniemployee->sortByDesc('id') as $index => $tniemployee)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>
                                            @php
                                            ...
                                            @endphp
                                            {{ $tniemployee->employee_code }}
                                        </td>
                                        <td>
                                            {{ $tniemployee->employee_name }}
                                        </td>

                                        <td>{{ $tniemployee->department }}</td>
                                        <!-- <td>{{ $tniemployee->location }}</td> -->
                                        <!-- <td>{{ $tniemployee->qualification }}</td> -->
                                        <td>{{ $tniemployee->joining_date }}</td>
                                        <td>

                                            <div class="action-buttons">

                                                <a href="{{ route('tniemployee.show', $tniemployee->id) }}">
                                                    <i class="fa-solid fa-pencil"></i>
                                                </a>
                                        </td>

                                        <td>
                                            <button type="button" class="view-report-btn"onclick="window.location.href='{{ url('tni_employee_report/' . $tniemployee->id) }}'" >
                                                <i class="fa fa-file-alt"></i>
                                                </button></td>
                                    </tr>


                                        <!-- <button type="button" class="view-report-btn"onclick="window.location.href='{{ url('rcms/induction_report/' . $tniemployee->id) }}'" >
                    <i class="fa fa-file-alt"></i>
                    </button> -->
                    </div>
                   ...
                   <div id="CCForm12" class="inner-block tms-block cctabcontent" style="margin-top:50px; ">
                        <div>
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                @foreach($departmentwise->sortByDesc('id') as $index => $dpw)
                                            <tr>
                                            <td>{{ $index + 1 }}</td>
                                            <td>{{ Helpers::getdateFormat($dpw->Prepared_date) }}</td>
                                            <td>{{ Helpers::getFullDepartmentName($dpw->department) }}</td>
                                            {{-- <td>{{$dpw->employee_name ? $dpw->employee_name : 'NA' }}</td> --}}
                                            <td>{{ \App\Models\Employee::find($dpw->employee_name)?->employee_name ?? 'NA' }}</td>

                                            <td>{{$dpw->status ? $dpw->status : 'NA' }}</td>
                                                                 <td> 
                                                <a href="{{ route('departmentwise_view', $dpw->id) }}">
                                                    <i class="fa-solid fa-pencil" style="color: #355cab;"></i>
                                                </a>
                                            </td>
                                        <td>

                                    <button type="button" class="view-report-btn"
                                        onclick="window.location.href='{{ route('department_wise_report', ['id' => $dpw->id]) }}'">
                                        <i class="fa fa-file-alt"></i>
                                    </button>
                ...
                {{----Yearly Training Plamnner----}}

            <div id="CCForm13" class="inner-block tms-block cctabcontent" style="margin-top:50px; ">
                {{-- @if (Helpers::checkRoles(6)) --}}
                <div>
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th>S.No.</th>
                                {{-- <th>Yearly Training Planner ID</th> --}}
                                <th>Topic</th>
                                <th>Start Date</th>
                                <th>End Date</th>
                                <th>Status</th>
                        ...
                        <tbody>
                            @foreach ($dataYTP->sortByDesc('id') as $index => $temp)
                                {{-- @foreach ($trainingTMM->sortByDesc('id') as $index => $temp) --}}
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    {{-- <td>{{ $temp->id }}</td> --}}
                                    <td>{{ $temp->topic }}</td>
                                    ...
                                    <td>{{ $temp->status }}</td>
                                    <td> <a href="{{ url('ytp_view', $temp->id) }}">
                                            <i class="fa-solid fa-pencil" style="color: #355cab;"></i> </td>
                                    {{-- <td>
                                    <button type="button" class="view-report-btn"
                                        onclick="window.location.href='{{ route('yearly.training', ['id' => $temp->id]) }}'">
                                        <i class="fa fa-file-alt"></i>
                                    </button>
                                    </td> --}}
                                </tr>
            ...
            <div id="CCForm14" class="inner-block tms-block cctabcontent" style="margin-top:50px; ">
                {{-- @if (Helpers::checkRoles(6)) --}}
                <div>
                    <table class="table table-bordered">
                        <thead>
                        ...
                        <tbody>
                            @foreach ($scormData->sortByDesc('id') as $index => $temp)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $temp->scorm_id }}</td>
                                    <td>{{ $temp->initiator_name }}</td>
                                    <td>{{ $temp->initiation_date_new }}</td>
                                    <td>{{ $temp->short_description }}</td>
                                    <td> <a href="{{ url('scorm_view', $temp->id) }}">
                                            <i class="fa-solid fa-pencil" style="color: #355cab;"></i>
                                     </td>
                                </tr>
                            @endforeach
...
{{-- ===============Equipment Training room================ --}}
            <div id="assigned" class="inner-block tms-block cctabcontent" style="margin-top:50px;">
                <div class="heading-tms">Equipment/Lifecycle Management Training</div>
                @php
                    $documentsCollection = collect($equipmentTraining);
                    $currentPage = request()->get('page', 1);
                    $perPage = 5;
                    $paginatedData = $documentsCollection->forPage($currentPage, $perPage);
                    $totalPages = ceil($documentsCollection->count() / $perPage);
                        ...
                        @php $rowNumber = 1; @endphp
                            ...
                            $encryptedTotalMinimumTime = Illuminate\Support\Facades\Crypt::encryptString($record->total_minimum_time);
                                ...
                                $quizResult = DB::table('emp_training_quiz_results')
                                    ->where([
                                        ...
                                        'training_type' => "Equipment/Lifecycle Management Training",
                                        'emp_id' => Auth::user()->id,
                            ...
                            @endphp
                                <tr>
                                    ...
                                    {{-- <td>
                                        {{ Helpers::getFullDepartmentName($record->departmentid) ?? 'N/A'}}
                                    </td> --}}
                                    ...
                                    @if(($record->per_screen_run_time * 60) > $record->sop_spent_time)
                                        <td><a href="{{ url('equipmentlifecycle-training-detail', ['start_dates' => $convertD, 'total_time' => $encryptedTotalMinimumTime, 'screen_time' => $encryptedPerScreenRunningTime, 'job_training_id' => $record->id, 'sop_spent_time' => $encryptedPerSOPSpentTime]) }}"><i class="fa-solid fa-eye"></i></a></td>
                                    @else
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <button type="button" class="btn btn-outline" style="background-color: #4274da; color: white;"
                                                            onclick="window.location.href='/equipmentQuestionShow/{{ $record->documentNumber }}/{{ $record->id }}';">
                                                        Attempt Quiz
                                                    </button>
                                                @endif
                                        </td>
...
{{-- ===============Class room================ --}}
<div id="CCFormClass" class="inner-block tms-block cctabcontent" style="margin-top:50px;">
                <div>
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ( $classroomtraining->sortByDesc('id') as $index => $job_training)
                            <tr>
                            <td>{{ $index + 1 }}</td>       
                                ...
                                {{-- <td>{{ \Carbon\Carbon::parse($job_training->{"start_date"})->format('d-M-Y') }}</td> --}}
                                    ...
                                    <a href="{{ route('classroom_training_view', $job_training->id) }}">
                                        <i class="fa-solid fa-pencil"></i>
                                    </a>
        ...
        <div id="CCForm8" class="inner-block tms-block cctabcontent" style="margin-top:50px;">
            <div>
                <table class="table table-bordered">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @if (!empty($Tni))
                            @php
                                $totalItems = $Tni->count();
                            @endphp
                            @foreach ($Tni->sortByDesc('id')->values() as $index => $tni_data)
                                <tr>
                                    
                                    <td>{{ $totalItems - $index }}</td>
                                    
                                    <td>
                                        @if ($tni_data->division_id == 'P1')
                                            P1 (Indore Location)
                                        @elseif($tni_data->division_id == 'P2')
                                            P2 (Pithampur Location)
                                        @elseif($tni_data->division_id == 'P4')
                                            P4 (Ujjain Site)
                                        @else
                                            C1 (China Plant)
                                        @endif
                                    ...
                                    <td>{{ Helpers::getInitiatorName($tni_data->initiator_id) }}</td>
                                    <td>{{ Helpers::getdateFormat($tni_data->initiation_date) }}</td>
                                    
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ url('rcms/edit-tni', $tni_data->id) }}"> <i class="fa fa-pencil-alt"></i></a>
                                        </div>
                                    </td>
                                    
                                    <td>
                                        <a href="{{ route('report', $tni_data->id) }}" target="_blank"> <i class="fa fa-file-alt"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        @endif
                        ...
                        @foreach ($inductionTraining->sortByDesc('id') as $index => $induction)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button"
                                        class="view-report-btn"onclick="window.location.href='{{ url('rcms/induction_report/' . $induction->id) }}'">
                                        <i class="fa fa-file-alt"></i>
                                    </button>
            </div>
            </td>
    ...
    <div id="CCForm7" class="inner-block tms-block cctabcontent" style="margin-top:50px;">
        <div>
            <table class="table table-bordered">
                ...
                <tbody>
                    @foreach ($jobTraining->sortByDesc('id') as $index=> $induction)
                        <tr>
                            <td>{{ $index + 1 }}</td>
                            <td>
                                @php
                            ...
                            <td>
                                ...
                                <button type="button"
                                    class="view-report-btn"onclick="window.location.href='{{ url('rcms/report/' . $induction->id) }}'">
                                    <i class="fa fa-file-alt"></i>
                                </button>
        </div>
        </td>
    ...
    <div id="CCForm9" class="inner-block tms-block cctabcontent" style="margin-top:50px; ">
        {{-- @if (Helpers::checkRoles(6)) --}}
        <div>
            <table class="table table-bordered">
                <thead>
                ...
                <tbody>
                    @foreach ($trainingTMM->sortByDesc('id') as $index => $temp)
                        ...
                        <tr>
                            <td>{{ $index + 1 }}</td>
                            <td>TMM{{ str_pad($temp->traning_material_id, 4, '0', STR_PAD_LEFT) }}</td>
                            <td>{{ $temp->title }}</td>
                            <td>{{ $temp->short_description }}</td>
                            <td>{{ Helpers::getdateFormat($temp->last_updated_date) }}</td>
                            <td>{{ $temp->status }}</td>
                            <td> <a href="{{ url('TMM_view', $temp->id) }}">
                                    <i class="fa-solid fa-pencil" style="color: #355cab;"></i>
                            </td>
                        </tr>
                    @endforeach
