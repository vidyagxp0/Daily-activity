                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex" style="gap:20px;">
                        ...
                        <button class="button_theme1">
                            <a class="text-white" href="{{ route('trainer.audittrail', $trainer->id) }}"><i class="fas fa-history"></i> Audit Trail
                            </a>
                        </button>
                ...
                <div id="CCForm1" class="inner-block cctabcontent">
                    <div class="inner-block-content">
                        <div class="row">
                            ...
                            <div class="sub-head">
                                <i class="fas fa-info-circle"></i> Trainer Information
                            </div>
                                ...
                                <div class="group-input">
                                    ...
                                    <select id="training-select" name="site_code" onchange="toggleMultiSelect()">
                                        ...
                                        <option value="P1(Indore Location)"
                                            @if ($trainer->site_code == 'P1(Indore Location)') selected @endif>
                                            P1 (Indore Location)</option>
                                        <option value="P2(Pithampur Location)"
                                            @if ($trainer->site_code == 'P2(Pithampur Location)') selected @endif>P2
                                            (Pithampur Location)
                                        </option>
                                        <option value="P4(Ujjain Site)" @if ($trainer->site_code == 'P4(Ujjain Site)') selected @endif>
                                            P4 (Ujjain
                                            Site)</option>
                                        <option value="C1(China Plant)" @if ($trainer->site_code == 'C1(China Plant)') selected @endif>
