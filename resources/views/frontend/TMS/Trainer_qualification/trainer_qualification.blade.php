                            ...
                            <div class="row">
                                        ...
                                        <select name="employee_name" id="employee_name" onchange="fetchEmployeeDetails()">
                                            ...
                                            @foreach ($employees as $employee)
                                                <option value="{{ $employee->employee_name }}"
                                                    ...
                                                    data-department="{{ Helpers::getDepartments()[$employee->department] ?? 'NA' }}"
                                                    data-designation="{{ $employee->job_title }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input" id="repeat_nature">
                                        ...
                                        <input type="number" name="experience" id="experience" readonly>
                                    </div>
                                </div>
                                ...
                                <script>
                                    function fetchEmployeeDetails() {
                                        ...
                                        if (employeeName) {
                                            ...
                                            document.getElementById('experience').value = experience || 'NA';
                                            document.getElementById('qualification').value = qualification || 'NA';
