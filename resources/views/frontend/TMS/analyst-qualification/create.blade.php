...
@section('container')
    ...
    <div class="form-field-head">
        ...
        <div class="division-bar">
            <strong>New Analyst Qualification</strong>
            {{-- <strong>Site Division/Project</strong> : --}}
            {{-- {{ Helpers::getDivisionName(session()->get('division')) }} Analyst Qualification --}}
        </div>
    </div>
                            ...
                            <div class="row">
                                ...
                                {{-- <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="trainer">Analyst Name</label>
    ...
    @endforeach
                ...
                <div class="group-input">
                    <label for="audit-agenda-grid">
                        Analyst Skill Set<button type="button" name="audit-agenda-grid" id="Trainer_Skill_table">+</button>
                    </label>
                    <table class="table table-bordered" id="Trainer_Skill_table_details">
                        <thead>
                            <tr>
                                <th style="width: 5%;">Sr. No.</th>
                                <th>Analyst Skill Set</th>
