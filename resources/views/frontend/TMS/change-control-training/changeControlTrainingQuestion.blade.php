...
<div class="quiz-container">
    @if ($changeControlTrainig->trainingAttempt == -1)
    ...
    @else
        ...
        <h1>Job Role Quiz</h1>
        <form action="{{ route('check_answer_changeControl') }}" method="POST">
            @csrf
            <input type="hidden"  name="training_id" value="{{ $changeControlTrainig->id }}">
            <input type="hidden"  name="parentId" value="{{ $changeControlTrainig->cc_id }}">
            <input type="hidden"  name="emp_id" value="{{ $changeControlTrainig->trainees }}">
            <input type="hidden"  name="employee_name" value="{{ Helpers::getEmpName($changeControlTrainig->trainees) }}">
            <input type="hidden"  name="training_type" value="Change Control SOP Training">
            <input type="hidden"  name="trainingAttempt" value="{{ $changeControlTrainig->trainingAttempt }}">
            <input type="hidden"  name="document_number" value="{{ $changeControlTrainig->documentNumber }}">
