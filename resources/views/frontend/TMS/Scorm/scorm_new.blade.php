                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <input type="text" name="scorm_id" value="{{$scorm_id}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <select name="validations">
                                            ...
                                            <option value="Shall be Completed">Shall be Completed</option>
                                            <option value="No Checks Required">No Checks Required</option>
                                        </select>
                                    </div>
                                </div>
