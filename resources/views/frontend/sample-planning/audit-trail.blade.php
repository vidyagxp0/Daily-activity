                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="buttons-new">
                            ...
                            <button class="button_theme1"><a class="text-white"
                                    href="{{ url('rcms/edit-sample-planning/' . $document->id) }}"> Back
                                </a>
                            </button>
                            ...
                            <div class="modal-content">
                                ...
                                @php
                                    $reviewer = DB::table('audit_reviewers_details')
                                        ->where(['doc_id' => $document->id, 'type' => 'Sample Planning'])
                                        ->get();
                                @endphp
                                <!-- Customer grid view -->
                                ...
                                <!-- <form action="" method="POST"> -->
                                    <form action="{{ route('store_audit_review', $document->id) }}" method="POST">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type="hidden" id="type" name="type" value="Sample Planning">
                                        </div>
