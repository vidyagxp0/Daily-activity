...
@section('container')
    ...
    <div id="change-control-fields">
        <div class="container-fluid">
            ...
            <form id="auditform" class="mainform" action="{{ route('store-sample-planning') }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <input disabled type="text" name="record_number"
                                            value="{{ Helpers::getDivisionName(session()->get('division')) }}/Sample Management/{{ date('Y') }}/{{ $record_number }}">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        <label style="display: flex; justify-content: space-between;" for="audit-agenda-grid">
                                           <div>
                                            Sample Management<button type="button" name="audit-agenda-grid"
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <div class="relative-container">
                                            <textarea class="tiny" name="samplePreprationComment"></textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <div class="relative-container">
                                            <textarea class="tiny" name="reviewer_comment"></textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <div class="relative-container">
                                            <textarea class="tiny" name="QA_reviewer_comment"></textarea>
                                        </div>
                                    </div>
                                </div>
