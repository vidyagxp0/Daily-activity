...
@section('container')
    ...
    <div class="form-field-head">
        <div class="pr-id training-title">
            Employee Training History Record
        </div>
    </div>
    <style>
       .header {
...
.right {
    ...
    <div id="change-control-fields">
        <div class="container-fluid">
            ...
            <form action="{{ route('employee.training.history') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!-- Tab content -->
                <div id="pdf-content">
                <div id="step-form">
                    <div id="CCForm1" class="inner-block cctabcontent">
                        <div class="inner-block-content">
                            <div class="pm-certificate-logos text-center">
                                ...
                                <p class="center" style="margin-left: 98px; font-size: 24px; font-weight: bold; white-space: nowrap;">EMPLOYEE TRAINING HISTORY RECORD</p>
...
<script>
    document.getElementById('exportPDF').addEventListener('click', function () {
        ...
        html2pdf().set(opt).from(element).toPdf().get('pdf').then(function (pdf) {
            ...
            pdf.save('Employee_Training_History_Record.pdf');
        });
    });
</script>
