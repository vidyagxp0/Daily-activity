                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="buttons-new">
                            ...
                            <button class="button_theme1"><a class="text-white"
                                    href="{{ url('task_management_show/' . $document->id) }}"> Back
                                </a>
                            </button> 
                                ...
                                <form action="{{ route('store_audit_review', $document->id) }}" method="POST">
                                    ...
                                    <div class="modal-body">
                                        <div class="group-input">
                                            <label for="Reviewer comment">Reviewer Comment <span class="text-danger">*</span></label>
                                        ...
                                        <div class="group-input">
                                            ...
                                            <input type="text" class="form-control" name="reviewer_completed_by" id="reviewer_completed_by" value="{{ $auditCollect ? $auditCollect->reviewer_comment_by : '' }}">
                                        </div>
                                        <div class="group-input">
                                            <label for="Reviewer Completed On">Reviewer Completed On</label>
                                            <input type="text" class="form-control" name="reviewer_completed_on" id="reviewer_completed_on" value="{{ $auditCollect ? $auditCollect->reviewer_comment_on : '' }}">
                                        </div>
