                    ...
                    <div class="row">
                            ...
                            <div class="group-input">
                                ...
                                <div class="col-md-12 4">
                                    <div class="group-input">
                                        ...
                                        <textarea class="tiny" name="comments_pli" id="summernote-1">{{ $micro_data->comments_pli }}
                                    </textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="group-input">
                                ...
                                <textarea class="tiny" name="justify_if_no_field_alert_pli" id="summernote-1">{{ $micro_data->justify_if_no_field_alert_pli }}
                                </textarea>
                            </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-12 mb-4">
                            <div class="group-input">
                                ...
                                <!-- <label for="Description Deviation">Description of Deviation</label> -->
                                <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                                <textarea class="tiny" name="justify_if_no_analyst_int_pli" id="summernote-1">{{ $micro_data->justify_if_no_analyst_int_pli }}
                                    </textarea>
        ...
        <div class="row">
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                    <textarea class="tiny" name="summary_of_prelim_investiga_plic" id="summernote-1">{{ $micro_data->summary_of_prelim_investiga_plic }}
                        </textarea>
                </div>
            </div>
            ...
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                    <textarea class="tiny" name="oos_category_others_plic" id="summernote-1">{{ $micro_data->oos_category_others_plic }}
                        </textarea>
                </div>
            </div>
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                    <textarea class="tiny" name="root_cause_details_plic" id="summernote-1">{{ $micro_data->root_cause_details_plic }}
                        </textarea>
                </div>
            </div>
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                    <textarea class="tiny" name="oos_category_root_cause_plic" id="summernote-1">{{ $micro_data->oos_category_root_cause_plic }}
                        </textarea>
                </div>
            </div>
            ...
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                    <textarea class="tiny" name="delay_justification_for_pi_plic" id="summernote-1">{{ $micro_data->delay_justification_for_pi_plic }}
                        </textarea>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                    <textarea class="tiny" name="review_comments_plir" id="summernote-1">{{ $micro_data->review_comments_plir }}
                    </textarea>
                </div>
            </div>
