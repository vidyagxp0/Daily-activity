                    ...
                    <div class="row">
                        ...
                        {{-- <div class="col-lg-6">
                            <div class="group-input">
                                ...
                                <input readonly type="text" name="record"
                        ...
                        <div class="col-lg-6">
                            <div class="group-input">
                                <label  for="Division Code">Division Code<span class="text-danger"></span></label>
                                <input readonly type="text" name="division_code_gi"
                        ...
                        <div class="col-lg-6">
                            <div class="group-input">
                                ...
                                <input readonly type="text" name="initiator"
                        ...
                        <div class="col-lg-6">
                            <div class="group-input">
                                ...
                                <select name="is_repeat_gi" onchange="otherController(this.value, 'Yes', 'is_repeat_gi')">
                                        <option value="">Enter Your Selection Here</option>
                        ...
                        <div class="col-md-6 new-date-data-field">
                            <div class="group-input input-date">
                                <label for="Deviation-Occurred On">Deviation Occured On</label>
                                <div class="calenderauditee">                                    
                        ...
                        <div class="col-lg-12 mb-4">
                            <div class="group-input">
                                ...
                                <div class="col-md-12 4">
                                    <div class="group-input">
                                      <textarea class="tiny" name="comments_pli" id="summernote-1">
                                    </textarea>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="group-input">
                                ...
                                <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                                <textarea class="tiny" name="oos_category_root_cause_plic" id="summernote-1">
                                    </textarea>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-4">
                            <div class="group-input">
                                ...
                                <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                                <textarea class="tiny" name="cq_review_comments_OOS_CQ" id="summernote-1">
                                        </textarea>
                            </div>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="group-input">
                                ...
                                <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                                <textarea class="tiny" name="other_action_BI" id="summernote-1">
                                        </textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="group-input">
                                ...
                                <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                                <textarea class="tiny" name="other_parameter_result_BI" id="summernote-1">
                                        </textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="group-input">
                                ...
                                <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                                <textarea class="tiny" name="trend_of_previous_batches_BI" id="summernote-1">
                                        </textarea>
                            </div>
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="group-input">
                                ...
                                <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                                <textarea class="tiny" name="stability_data_BI" id="summernote-1">
                                        </textarea>
                            </div>
                        </div>
                        <div class="col-md-12 mb-4">
                            <div class="group-input">
                                ...
                                <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                                <textarea class="tiny" name="process_validation_data_BI" id="summernote-1">
                                        </textarea>
                            </div>
                        </div>
                        <div class="col-md-12 mb-4">
                            <div class="group-input">
                                ...
                                <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                                <textarea class="tiny" name="method_validation_BI" id="summernote-1">
                                        </textarea>
                            </div>
                        </div>
                        <div class="col-md-12 mb-4">
                            <div class="group-input">
                                ...
                                <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                                <textarea class="tiny" name="any_market_complaints_BI" id="summernote-1">
                                        </textarea>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-4">
                            <div class="group-input">
                                <label for="Description Deviation">Other Action (Specify)</label>
                                <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                                <textarea class="tiny" name="reopen_request" id="summernote-1">
                                        </textarea>
                            </div>
                        </div>
