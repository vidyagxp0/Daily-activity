                                    ...
                                    <div class="inner-block-content">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-3 Other2_reviews">
                                                <div class="group-input">
                                                    <label for="Impact Assessment13">Impact Assessment (By Other's 2)</label>
                                                    <textarea class="tiny" name="Other2_Assessment" id="summernote-43" readonly>{{ $data1->Other2_Assessment }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            @if ($data->stage == 3 || $data->stage == 4)
                                                ...
                                                <div class="col-md-12 mb-3 Other3_reviews">
                                                    <div class="group-input">
                                                        ...
                                                        <textarea class="tiny" name="Other3_Assessment" id="summernote-43" @if ($data1->Other3_review == 'yes' && $data->stage == 4) required @endif
                                            ...
                                            @else
                                                ...
                                                <div class="col-md-12 mb-3 Other3_reviews">
                                                    <div class="group-input">
                                                        <label for="Impact Assessment13">Impact Assessment (By Other's 3)</label>
                                                        <textarea class="tiny" name="Other3_Assessment" id="summernote-43" readonly>{{ $data1->Other3_Assessment }}</textarea>
                                                    </div>
                                                </div>
                                            ...
                                            @if ($data->stage == 3 || $data->stage == 4)
                                                ...
                                                <div class="col-md-12 mb-3 Other4_reviews">
                                                    <div class="group-input">
                                                        ...
                                                        <textarea class="tiny" name="Other4_Assessment" id="summernote-43" @if ($data1->Other4_review == 'yes' && $data->stage == 4) required @endif
                                            ...
                                            @else
                                                ...
                                                <div class="col-md-12 mb-3 Other4_reviews">
                                                    <div class="group-input">
                                                        <label for="Impact Assessment13">Impact Assessment (By Other's 4)</label>
                                                        <textarea class="tiny" name="Other4_Assessment" id="summernote-43" readonly>{{ $data1->Other4_Assessment }}</textarea>
                                                    </div>
                                                </div>
                                            ...
                                            @if ($data->stage == 3 || $data->stage == 4)
                                                ...
                                                <div class="col-md-12 mb-3 Other5_reviews">
                                                    <div class="group-input">
                                                        ...
                                                        <textarea class="tiny" name="Other5_Assessment" id="summernote-43" @if ($data1->Other5_review == 'yes' && $data->stage == 4) required @endif
                                            ...
                                            @else
                                                ...
                                                <div class="col-md-12 mb-3 Other5_reviews">
                                                    <div class="group-input">
                                                        <label for="Impact Assessment13">Impact Assessment (By Other's 5)</label>
                                                        <textarea class="tiny" name="Other5_Assessment" id="summernote-43" readonly>{{ $data1->Other5_Assessment }}</textarea>
                                                    </div>
                                                </div>
