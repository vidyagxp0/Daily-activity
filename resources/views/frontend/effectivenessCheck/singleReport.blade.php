            ...
            <div class="block">
                ...
                <table>
                    ...
                    <tr>
                        <th class="w-20">
                            Submit Comment</th>
                        <td class="w-30" colspan="3">{{ $data->submit_comment }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="w-30" colspan="3">{{ $data->work_complition_comment }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th class="w-20">
                            Complete Comment</th>
                        <td class="w-30" colspan="3">{{ $data->effectiveness_check_complete_comment }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="w-30" colspan="3">{{ $data->hod_review_complete_comment }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="w-30" colspan="3">{{ $data->qa_review_complete_comment }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="w-30" colspan="3">{{ $data->not_effective_approval_complete_comment }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="w-30" colspan="3">{{ $data->effective_comment }}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="w-30" colspan="3">{{ $data->effective_approval_complete_comment }}</td>
                    </tr>
                    ...
                    <tr>
                        <th class="w-20">
                            Cancel Comment</th>
                        <td class="w-30" colspan="3">{{ $data->closed_cancelled_comment }}</td>
                    </tr>
