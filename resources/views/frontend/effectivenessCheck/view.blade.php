                    ...
                    <div id="CCForm1" class="inner-block cctabcontent">
                        ...
                        <div class="inner-block-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="group-input">
                                        ...
                                        <select id="select-state" placeholder="Select..." name="assign_to"
                                            {{ $data->stage == 0 || $data->stage == 6 || $data->stage == 8 ? 'disabled' : '' }}>
                                ...
                                $initiationDate = $data->intiation_date; // Current date as initiation date
                                    ...
                                    <div class="group-input input-date">
                                        ...
                                        <div class="calenderauditee">
                                            ...
                                            <input type="date" name="due_date"
                                                min="{{ \Carbon\Carbon::now()->format('d-M-Y') }}" style="display: none"
                                                class="hide-input " value="{{ Helpers::getDueDate(30, false) }}"
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <input type="text" name="short_description" id="docname" required
                                            {{ $data->stage == 0 || $data->stage == 7 || $data->stage == 8 || $data->stage == 9 ? 'disabled' : '' }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="group-input">
                                    ...
                                    <textarea type="text"
                                        name="Effectiveness_Results"{{ $data->stage == 0 || $data->stage == 7 || $data->stage == 8 || $data->stage == 9 ? 'disabled' : '' }}>{{ $data->Effectiveness_Results }}</textarea>
                                </div>
                            </div>
                            <!-- <div class="col-lg-6">
                                        <div class="group-input">
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea type="text" name="effect_summary"
                                        {{ $data->stage == 0 || $data->stage == 7 || $data->stage == 8 || $data->stage == 9 ? 'disabled' : '' }}> {{ $data->effect_summary }}</textarea>
                                </div>
                            </div>
                            {{-- <div class="col-12 sub-head">
                                    Reopen
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea name="Comments"
                                        {{ $data->stage == 0 || $data->stage == 7 || $data->stage == 8 || $data->stage == 9 ? 'disabled' : '' }}>{{ $data->Comments }}</textarea>
                                </div>
                            </div>
                            <!-- <div class="col-lg-6">
                                        <div class="group-input">
                                ...
                                <div class="group-input">
                                    ...
                                    <div class="file-attachment-field">
                                        ...
                                        <div class="add-btn">
                                            ...
                                            <input
                                                {{ $data->stage == 0 || $data->stage == 7 || $data->stage == 8 || $data->stage == 9 ? 'disabled' : '' }}
                                                value="{{ $data->Attachment }}" type="file" id="myfile"
                                                name="Attachment[]" oninput="addMultipleFiles(this, 'Attachment')"
                                                multiple>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="group-input">
                                    ...
                                    <div class="file-attachment-field">
                                        ...
                                        <div class="add-btn">
                                            ...
                                            <input
                                                {{ $data->stage == 0 || $data->stage == 7 || $data->stage == 8 || $data->stage == 9 ? 'disabled' : '' }}
                                                value="{{ $data->qa_cqa_review_Attachment }}" type="file"
                                                id="myfile" name="qa_cqa_review_Attachment[]"
                                ...
                                <div class="group-input">
                                    ...
                                    <div class="file-attachment-field">
                                        ...
                                        <div class="add-btn">
                                            ...
                                            <input
                                                {{ $data->stage == 0 || $data->stage == 7 || $data->stage == 8 || $data->stage == 9 ? 'disabled' : '' }}
                                                value="{{ $data->qa_cqa_approval_Attachment }}" type="file"
                                                id="myfile" name="qa_cqa_approval_Attachment[]"
