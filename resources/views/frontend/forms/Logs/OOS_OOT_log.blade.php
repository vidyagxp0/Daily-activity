                                        ...
                                        <div class="d-flex align-items-center">
                                            <div style="    display: grid;    grid-template-columns: 1fr 1fr 1fr 1fr 1fr;" class="filter-bar row">
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <select class="custom-select" id="division_id_oos">
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <input type="date" class="custom-select" id="date_fromoos">
                                                </div>
                        
                                                <!-- End Date Filter -->
                                                <div class=" mb-3">
                                                    <label for="date_to_deviation">End Date:</label>
                                                    <input type="date" class="custom-select" id="date_tooos">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#initiator_group').change(function() {
            filterData.department_oos = this.value;
            filterRecords();
        });
    
        $('#division_id_oos').change('change', function() {
            filterData.division_id_oos = this.value;
            filterRecords();
        });
    
        document.getElementById('initiator_id').addEventListener('change', function() {
            filterData.initiator_id_oos = this.value;
            filterRecords();
        });
    
        document.getElementById('date_fromoos').addEventListener('change', function() {
            filterData.date_fromoos = this.value;
            filterRecords();
        });
    
        document.getElementById('date_tooos').addEventListener('change', function() {
            filterData.date_tooos = this.value;
            filterRecords();
        });
    // ===============local=============
...
<script>
    ...
    const changerelateTo = document.getElementById('division_id_oos').value;
    const Initiator = document.getElementById('initiator_id').value;
    const dateFrom = document.getElementById('date_fromoos').value;
    const dateTo = document.getElementById('date_tooos').value;
  
    const url = `/api/print-oot?department=${department}&changerelateTo=${changerelateTo}&Initiator=${Initiator}&dateFrom=${dateFrom}&dateTo=${dateTo}`;
