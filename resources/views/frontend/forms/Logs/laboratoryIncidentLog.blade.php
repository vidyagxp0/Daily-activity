...
@section('rcms_container')
    ...
    <style>
        ...
        #division_id_labincident{
            border: 1px solid #bfd0f2 !important;
            border-radius: 2px !important; 
        } 
        #date_fromlabincident{
            border: 1px solid #bfd0f2 !important;
            border-radius: 2px !important;   
        } 
        #date_tolabincident{
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div style="    display: grid;    grid-template-columns: 1fr 1fr 1fr 1fr 1fr;" class="filter-bar row">
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <select class="custom-select" id="division_id_labincident">
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <input type="date" class="custom-select" id="date_fromlabincident">
                                                </div>
                        
                                                <!-- End Date Filter -->
                                                <div class=" mb-3">
                                                    <label for="date_to_deviation">End Date:</label>
                                                    <input type="date" class="custom-select" id="date_tolabincident">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function(){
        const filterData = {
            department_labincident: [],
            division_id_labincident: null,
            initiator_id_labincident: [],
            date_fromlabincident: null,
            date_tolabincident: null,
            sort_column: '',
            sort_order: ''
        };
    
        $('#initiator_group').change(function() {
            filterData.department_labincident = this.value;
            filterRecords();
        });
    
        $('#division_id_labincident').change('change', function() {
            filterData.division_id_labincident = this.value;
            filterRecords();
        });
    
        document.getElementById('initiator_id').addEventListener('change', function() {
            filterData.initiator_id_labincident = this.value;
            filterRecords();
        });
    
        document.getElementById('date_fromlabincident').addEventListener('change', function() {
            filterData.date_fromlabincident = this.value;
            filterRecords();
        });
    
        document.getElementById('date_tolabincident').addEventListener('change', function() {
            filterData.date_tolabincident = this.value;
            filterRecords();
        });
    // ===============local=============
...
<script>
    ...
    const changerelateTo = document.getElementById('division_id_labincident').value;
    const Initiator = document.getElementById('initiator_id').value;
    const dateFrom = document.getElementById('date_fromlabincident').value;
    const dateTo = document.getElementById('date_tolabincident').value;
    const url = `/api/print-labincident?department=${department}&changerelateTo=${changerelateTo}&Initiator=${Initiator}&dateFrom=${dateFrom}&dateTo=${dateTo}`;
