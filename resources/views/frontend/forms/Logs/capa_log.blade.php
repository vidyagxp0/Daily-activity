...
<script>
    $(document).ready(function(){
        ...
        document.getElementById('date_fromcapa').addEventListener('change', function() {
            filterData.date_fromcapa = this.value;
            filterRecords();
        });
...
<script>
    ...
    const dateFrom = document.getElementById('date_fromcapa').value;
