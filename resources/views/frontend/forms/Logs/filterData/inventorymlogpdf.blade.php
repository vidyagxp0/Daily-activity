            ...
            <tr>
                <td class="w-50">
                    <div class="header-title">
                        <h3 style="margin-left: 100px">Inventory Management Log Report</h3>
                    </div>
                </td>
    ...
    <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $doc->division ? $doc->division->name : 'Not Applicable' }}/IM/{{ date('Y') }}/{{ str_pad($doc->record, 4, '0', STR_PAD_LEFT) }}</td>
