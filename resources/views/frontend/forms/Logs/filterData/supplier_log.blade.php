                                    ...
                                    <div class="d-flex align-items-center">
                                        <div style="    display: grid;    grid-template-columns: 1fr 1fr 1fr 1fr 1fr;" class="filter-bar row">
                                            ...
                                            <div class=" mb-3">
                                                ...
                                                <select class="custom-select" id="division_id_supplier">
                                            ...
                                            <div class=" mb-3">
                                                ...
                                                <input type="date" class="custom-select" id="date_fromsupplier">
                                            </div>
                    
                                            <!-- End Date Filter -->
                                            <div class=" mb-3">
                                                <label for="date_to_deviation">End Date:</label>
                                                <input type="date" class="custom-select" id="date_tosupplier">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<div id="rcms-desktop">
    <div class="main-content">
                                ...
                                <table class="table table-bordered table-hover" style="background-color: #fff; border-collapse: collapse; text-align: left;">
                                    <thead style="background-color: #797979; color: #000;">
                                        <tr>
                                            ...
                                            <th  style="background-color: #bfd0f2" class="sortable" onclick="sortTable('Initiator_Group')">Division</th>
                                            <th  style="background-color: #bfd0f2" class="sortable" onclick="sortTable('Initiator_Group')">Department Name</th>
                                            <th style="background-color: #bfd0f2">Short Description</th>
                                            <th style="background-color: #bfd0f2" class="sortable" onclick="sortTable('due_date')">Due Date</th>
        ...
        <div class="alert my-3" style="background: linear-gradient(135deg, #e3f2fd, #ffffff); border: 1px solid rgb(236,160,53); border-radius: 16px; padding: 30px; box-shadow: 0px 6px 12px rgba(0, 0, 0, 0.1);">
            <!-- Pharma Icon -->
