...
@forelse ($capa as $index => $doc)  
        ...
        <tr>
                ...
                <td>
                    <a href="{{ route('capashow', $doc->id) }}"  style="color: rgb(236,160,53); font-weight: bold; font-size: 13px;"  onmouseover="this.style.color='orange'" onmouseout="this.style.color='orange'">
