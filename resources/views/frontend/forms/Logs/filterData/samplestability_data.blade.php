...
@forelse ($samplestability as $index => $doc)  
    ...
    <tr>
        ...
        <td>
            <a href="{{ route('ViewSamplingStability', $doc->id) }}" target="_blank" style="color: rgb(236,160,53); font-weight: bold; font-size: 16px;">
               {{ $doc->division ? $doc->division->name : ' Not Applicable ' }}/SS/{{ date('Y') }}/{{ str_pad($doc->record, 4, '0', STR_PAD_LEFT) }}
            </a>
        </td>
        ...
        <td>{{ $doc->short_desc ?: ' Not Applicable ' }}</td>
