...
@forelse ($cm as $index => $doc)  
        ...
        <tr>
                ...
                <td>
                    <a href="{{ route('showCalibrationDetails', $doc->id) }}"style="color: rgb(236,160,53); font-weight: bold; font-size: 13px;"  onmouseover="this.style.color='orange'" onmouseout="this.style.color='orange'">
               ...
               <td>{{ $doc->callibration_frequency ? $doc->callibration_frequency : ' Not Applicable ' }}</td>
