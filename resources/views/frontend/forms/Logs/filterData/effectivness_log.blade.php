                        ...
                        <div>
                            <div class="row justify-content-center">
                                    <div class="active text-center" onclick="openTab('internal-audit', this)" 
                                        ...
                                        <strong>Effectivness Check LOG</strong>
...
<script>
    $(document).ready(function(){
        ...
        document.getElementById('date_to_effectivness').addEventListener('change', function() {
            filterData.date_toeffectivness = this.value;
            filterRecords();
        });
...
// ============================= Live Server Working Function ==========================//
    ...
    const url = `/api/print-effectivness?department=${department}&division=${division}&date_from=${dateFrom}&date_to=${dateTo}`;
