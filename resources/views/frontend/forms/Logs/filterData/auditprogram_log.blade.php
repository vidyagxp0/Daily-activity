                    ...
                    <div class="scroll-container">
                        <div class="table-block">
                            ...
                            <div style="padding: 10px; display: flex; justify-content: space-between; align-items: center; gap: 5px;">
                                <div>
                                    <select id="dateFilter" onchange="filterByDueDate()" style="padding: 10px; border: 1px solid #bfd0f2; border-radius: 5px; font-size: 14px;">
                                ...
                                <div style="position: relative; width: 300px;">
                                    ...
                                    >
                                    <span 
                                        style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); color: #bfd0f2; font-size: 16px; cursor: pointer;">
                                        🔍
                                    </span>
                                </div>
                            </div>
