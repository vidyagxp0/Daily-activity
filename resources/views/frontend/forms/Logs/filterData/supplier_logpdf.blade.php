    ...
    <table>
            ...
            <tbody >
                ...
                <tr>
                    ...
                    <td>{{ $doc->division ? $doc->division->name : 'Not Applicable' }}<br>/Supplier/{{ date('Y') }}/{{ str_pad($doc->record, 4, '0', STR_PAD_LEFT) }}</td>
                    <td>{{ $doc->division ? $doc->division->name : 'Not Applicable' }}</td>
                    <td>{{ Helpers::getInitiatorGroupFullName($doc->initiation_group) ?: 'Not Applicable' }}</td>
