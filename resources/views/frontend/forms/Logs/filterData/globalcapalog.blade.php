                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="filter-bar row">
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    ...
                                                    <select class="custom-select" id="division_id_globalcapa">
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    ...
                                                    <input type="date" class="custom-select" id="date_fromglobalcapa">
                                                </div>
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    ...
                                                    <input type="date" class="custom-select" id="date_toglobalcapa">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
