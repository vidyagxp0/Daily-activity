                        ...
                        <div>
                            <div class="row justify-content-center">
                                    <div class="active text-center" onclick="openTab('internal-audit', this)" 
                                        ...
                                        <strong>EHS ENVIRONMENT SUSTAINABILITY LOG
                                        </strong>
                    ...
                    <div class="scope-bar d-flex justify-content-end py-1">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{ route('export.csvehs') }}">CSV Export</a>
                                <a class="dropdown-item" href="{{ route('export.excelehs') }}">Excel Export</a>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="filter-bar row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <label for="initiator_group"><strong>Type</strong></label>
