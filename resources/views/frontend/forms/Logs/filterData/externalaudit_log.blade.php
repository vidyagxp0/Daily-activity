                        ...
                        <div>
                            <div class="row justify-content-center">
                                    <div class="active text-center" onclick="openTab('internal-audit', this)" 
                                        ...
                                        <strong>External Audit LOG</strong>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="filter-bar row">
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    ...
                                                    <select class="custom-select" id="division_id_ea">
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    ...
                                                    <input type="date" class="custom-select" id="date_fromea">
                                                </div>
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    ...
                                                    <input type="date" class="custom-select" id="date_toea">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
