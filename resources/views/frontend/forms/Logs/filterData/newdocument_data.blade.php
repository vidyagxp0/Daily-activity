...
@forelse ($newdocument as $index => $doc)  
        ...
        <tr>
                ...
                <td>
                    <a href="{{ route('documents.edit', $doc->id) }}" style="color: rgb(236,160,53);font-weight: bold; font-size: 13px;" target="_blank" onmouseover="this.style.color='red'" onmouseout="this.style.color='orange'">
