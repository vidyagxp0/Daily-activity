                                    ...
                                    <div class="mt-1 mb-2 bg-white" style="height: auto; padding: 10px; margin: 5px;">
                                        <div class="d-flex align-items-center">
                                            <div style="    display: grid;    grid-template-columns: 1fr 1fr 1fr 1fr 1fr;" class="filter-bar row">
                                                <!-- Department Filter -->
                                                <div class=" mb-3">
                                                    <label for="initiator_group">PM Schedule:</label>
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <select class="custom-select" id="division_id_preventive">
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <input type="date" class="custom-select" id="date_frompreventive">
                                                </div>
                        
                                                <!-- End Date Filter -->
                                                <div class=" mb-3">
                                                    <label for="date_to_deviation">End Date:</label>
                                                    <input type="date" class="custom-select" id="date_topreventive">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <table class="table table-bordered table-hover" style="background-color: #fff; border-collapse: collapse; text-align: left;">
                                    <thead style="background-color: #797979; color: #000;">
                                        <tr>
                                            ...
                                            <th class="sortable" style="background-color: #f5c27f" onclick="sortTable('pm_schedule')">PM Schedule</th>
...
<script>
    $(document).ready(function(){
        const filterData = {
            department_preventive: [],
            division_id_preventive: null,
            initiator_id_preventive: [],
        ...
        $('#division_id_preventive').change('change', function() {
...
<script>
    ...
    const url = `/api/print-preventiveM?department=${department}&changerelateTo=${changerelateTo}&Initiator=${Initiator}&dateFrom=${dateFrom}&dateTo=${dateTo}`;
