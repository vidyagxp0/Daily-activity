...
<body>
    ...
    <table>
            <tbody>
                ...
                <tr>
                    <td>{{ $index + 1 }}</td>
                    <td><a href="{{ route('showpreventive', $doc->id) }}" target="_blank" style="color: rgb(000,000,000); font-weight: bold; font-size: 12px;">{{ $doc->division ? $doc->division->name : ' Not Applicable ' }}<br>/PM/{{ date('Y') }}/{{ str_pad($doc->record, 4, '0', STR_PAD_LEFT) }}</a></td>
