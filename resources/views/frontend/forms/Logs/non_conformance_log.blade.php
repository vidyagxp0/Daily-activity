            ...
            <div class="scope-bar" style="display: flex;  padding:10px;  justify-content: space-between;">
                <div class="dropdown" style=" border-top : none; border-bottom:none;">
                    <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="width: 80px;">
                        ...
                        <a class="dropdown-item" href="{{ route('exportcsvnc') }}">CSV Export</a>
                        <a class="dropdown-item" href="{{ route('exportexcelnc') }}">Excel Export</a>
                        <a class="dropdown-item" href="#" onclick="printTable()">Print</a>
                    </div>
                </div>
                <div class="active" onclick="openTab('internal-audit', this)"  style="padding: 12px;  border-top : none; border-bottom:none; margin-right: 650px;">
                 <strong> Non Conformance Log </strong></div>
                            ...
                            <div class="d-flex flex-wrap align-items-center">
                                <div class="flex-grow-2">   
                                    <div class="filter-bar d-flex flex-wrap justify-content-between">
                                        ...
                                        <div class="filter-item">
                                            <label for="date_from_nonconformanc">Date From</label>
                                            <input type="date" class="form-control" id="date_from_nonconformanc">
                                        </div>
                                        <div class="filter-item">
                                            <label for="date_to_nonconformance">Date To</label>
                                            <input type="date" class="form-control" id="date_to_nonconformance">
                                        </div>
                                        <div class="filter-item">
                                            <label for="originator_nonconformance">Type of Document</label>
                                            <select class="form-control" id="originator_nonconformance">
                                                <option value="all">All Records</option>
                                            </select>
                                        </div>
                                        <div class="filter-item">
                                            <label for="datewise_nonconformance">Select Period</label>
...
$('#initiator_group').change(function() {
        ...
        $('#datewise_nonconformance').change(function() {
            filterData.period_non = $(this).val();
            filterRecords();
        });
...
<script>
 ...
 const division = document.getElementById('criteria').value;
 const dateFrom = document.getElementById('date_from_nonconformanc').value;
 const dateTo = document.getElementById('date_to_nonconformance').value;

 const url = `/api/print-nnconfermance?department=${department}&division=${division}&date_from=${dateFrom}&date_to=${dateTo}`;
