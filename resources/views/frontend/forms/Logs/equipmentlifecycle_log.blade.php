                                ...
                                >
                                    <h4 
                                        style="
                                            ...
                                            color: #000;"
                                    >
                                        Equipment/Instrument LifeCycle Log
                                    </h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div style="padding: 5px;" class="scope-bar d-flex justify-content-end py-1">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{ route('export.equipment.csv') }}">
                                    <i class="fas fa-file-csv"></i> CSV Export
                                </a>
                                <a class="dropdown-item" href="{{ route('export.equipment.excel') }}">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div style="    display: grid;    grid-template-columns: 1fr 1fr 1fr 1fr 1fr;" class="filter-bar row">
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <select class="custom-select" id="division_id_equipment">
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <input type="date" class="custom-select" id="date_fromequipment">
                                                </div>
                        
                                                <!-- End Date Filter -->
                                                <div class=" mb-3">
                                                    <label for="date_to_deviation">End Date:</label>
                                                    <input type="date" class="custom-select" id="date_toequipment">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <table class="table table-bordered table-hover" style="background-color: #fff; border-collapse: collapse; text-align: left;">
                                    <thead style="background-color: #797979; color: #000;">
                                        <tr>
                                            ...
                                            <th class="sortable" style="background-color: #f5c27f" onclick="sortTable('Initiator_Group')">Criticality Level</th>
...
<script>
    $(document).ready(function(){
        const filterData = {
            ...
            division_id_equipment: null,
            initiator_id_equipment: [],
            date_fromequipment: null,
            date_toequipment: null,
            sort_column: '',
            sort_order: ''
        };
    
        $('#initiator_group').change(function() {
            filterData.department_equipment = this.value;
            filterRecords();
        });
    
        $('#division_id_equipment').change('change', function() {
            filterData.division_id_equipment = this.value;
            filterRecords();
        });
    
        document.getElementById('initiator_id').addEventListener('change', function() {
            filterData.initiator_id_equipment = this.value;
            filterRecords();
        });
    
        document.getElementById('date_fromequipment').addEventListener('change', function() {
            filterData.date_fromequipment = this.value;
            filterRecords();
        });
    
        document.getElementById('date_toequipment').addEventListener('change', function() {
            filterData.date_toequipment = this.value;
            filterRecords();
        });
    // ===============local=============
...
<script>
    ...
    const changerelateTo = document.getElementById('division_id_equipment').value;
    const Initiator = document.getElementById('initiator_id').value;
    const dateFrom = document.getElementById('date_fromequipment').value;
    const dateTo = document.getElementById('date_toequipment').value;
