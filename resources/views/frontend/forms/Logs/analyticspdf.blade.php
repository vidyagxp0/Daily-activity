...
<body>
            ...
            <tr>
                <td class="w-50">
                    <div class="header-title">
                        <h3 style="margin-left: 100px">Analytics Qualification Log Report</h3>
                    </div>
                </td>
    ...
    <table>
            <tbody>
                ...
                <tr>
                    <td>{{ $index + 1 }}</td>
                    <td>{{ $doc->date_of_initiation ? \Carbon\Carbon::parse($doc->intiation_date)->format('d-M-Y') : 'Not Applicable' }}</td>
                    <td>
                        <a href="{{ route('analytics_qualification.show', $doc->id) }}" target="_blank" style="color: rgb(000,000,000); font-weight: bold; font-size: 13px;">
                        {{ $doc->site_code ? $doc->site_code : ' Not Applicable ' }}<br>/AQ/{{ date('Y') }}/{{ str_pad($doc->record_number, 4, '0', STR_PAD_LEFT) }}
                        </a>
                            </td>
                <td>{{ $doc->site_code ? $doc->site_code : ' Not Applicable ' }}</td>
                <td>{{ Helpers::getFullDepartmentName($doc->department) ?: ' Not Applicable ' }}</td>
                ...
                <td>{{ $doc->initiator ? $doc->initiator : ' Not Applicable ' }}</td>
        ...
        <table class="footer-table" style="width: 100%; text-align: center;">
            <tr>
                <td style="width: 33%; text-align: left;">
                    ...
                    <td>{{ optional($doc->initiator)->initiator ?: 'Not Applicable' }}</td>
                </td>
