                    ...
                    <div style="padding: 5px;" class="scope-bar d-flex justify-content-end py-1">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{ route('export.csv.rca')}}">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div style="    display: grid;    grid-template-columns: 1fr 1fr 1fr 1fr 1fr;" class="filter-bar row">
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <select class="custom-select" id="division_idrca">
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <input type="date" class="custom-select" id="date_from_rca">
                                                </div>
                        
                                                <!-- End Date Filter -->
                                                <div class=" mb-3">
                                                    <label for="date_to_deviation">End Date:</label>
                                                    <input type="date" class="custom-select" id="date_to_rca">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function(){
        ...
        document.getElementById('initiator_id').addEventListener('change', function() {
            filterData.initiator_id_rca = this.value;
            filterRecords();
        });
...
<script>
    ...
    const changerelateTo = document.getElementById('division_idrca').value;
    ...
    const url = `/api/print-rca?department=${department}&changerelateTo=${changerelateTo}&date_from=${dateFrom}&date_to=${dateTo}`;
