                                        ...
                                        <div class="d-flex align-items-center">
                                            <div style="    display: grid;    grid-template-columns: 1fr 1fr 1fr 1fr 1fr;" class="filter-bar row">
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <select class="custom-select" id="division_id_risk">
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <input type="date" class="custom-select" id="date_from_risk">
                                                </div>
                        
                                                <!-- End Date Filter -->
                                                <div class=" mb-3">
                                                    <label for="date_to_deviation">End Date:</label>
                                                    <input type="date" class="custom-select" id="date_to_risk">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="table-block">
                            ...
                            <div style="padding: 10px; display: flex; justify-content: space-between; align-items: center; gap: 5px;">
                                ...
                                <input 
                                    ...
                                    @endcomponent
                                    <span 
                                        style="position: absolute; right: 70px; top: 50%; transform: translateY(-50%); color: rgb(236,160,53); font-size: 16px; cursor: pointer;">
                                        🔍
                                    </span>
                                </div>
                                </div>
...
<script>
    ...
    const changerelateTo = document.getElementById('division_id_risk').value;
    const Initiator = document.getElementById('initiator_id').value;
    const dateFrom = document.getElementById('date_from_risk').value;
    const dateTo = document.getElementById('date_to_risk').value;
   
   
    const url = `/api/print-riskmt?department=${department}&changerelateTo=${changerelateTo}&date_from=${dateFrom}&date_to=${dateTo}`;
