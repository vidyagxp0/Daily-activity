                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        @if(!empty($parent_id))
                                            ...
                                            <input disabled type="text" name="record" id="record" value="{{ Helpers::getDivisionName($parent_division_id) }}/CAPA/{{ date('Y') }}/{{ $record_number }}">
                                        @else
                                            <input  type="hidden" name="record" id="record"  value="{{ $record_number }}">
                                            <input disabled type="text" name="record" id="record" value="{{ Helpers::getDivisionName(session()->get('division')) }}/CAPA/{{ date('Y') }}/{{ $record_number }}">
                                        @endif
                                    </div>
                                </div>
