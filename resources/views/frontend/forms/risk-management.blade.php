                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            ...
                                            <select name="Initiator_Group" id="initiator_group">
                                                <option Value="">--Select Group--</option>                                                <option value="CQA" @if(old('Initiator_Group') =="CQA") selected @endif>Corporate Quality Assurance</option>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            ...
                                            <select name="type" id="type">
                                                ...
                                                <option value="Customer-Related Risk(Complaint)">Customer-Related Risk(Complaint)</option>
                                    ...
                                    <div class="col-6">
                                        <div class="group-input">
                                            ...
                                            <div class="relative-container">
                                            <textarea name="description" id="description" class="tiny"></textarea>
                                            @component('frontend.forms.language-model')
                                            @endcomponent
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="group-input">
                                            ...
                                            <div class="relative-container">
                                            <textarea name="comments" id="comments" class="tiny"></textarea>
                                            @component('frontend.forms.language-model')
                                            @endcomponent
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="group-input">
                                            ...
                                            <div class="relative-container">
                                            <textarea name="justification" id="justification" class="tiny"></textarea>
                                            @component('frontend.forms.language-model')
                                            @endcomponent
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="group-input">
                                            ...
                                            <div class="relative-container">
                                            <textarea name="hazard_analysis" class="tiny"></textarea>
                                            @component('frontend.forms.language-model')
                                            @endcomponent
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="group-input">
                                            ...
                                            <div class="relative-container">
                                            <textarea name="root_cause_description" class="tiny"></textarea>
                                            @component('frontend.forms.language-model')
                                            @endcomponent
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="group-input">
                                            ...
                                            <div class="relative-container">
                                            <textarea name="investigation_summary" class="tiny"></textarea>
                                            @component('frontend.forms.language-model')
                                            @endcomponent
                                            </div>
                                        </div>
                                   ...
                                   <div class="col-lg-6">
                                    ...
                                    <div class="col-12">
                                        <div class="group-input">
                                            ...
                                            <div class="relative-container">
                                            <textarea name="comments2" id="comments2" class="tiny"></textarea>
                                            @component('frontend.forms.language-model')
                                            @endcomponent
                                            </div>
                                        </div>
                                ...
                                <td><button type="button" class="removeRowBtn">Remove</button></td>
                                    ...
                                    <div class="col-12">
                                        <div class="group-input" id="initiated_through_req">
                                            ...
                                            <div class="relative-container">
                                            <textarea  name="mitigation_plan" class="tiny"></textarea>
                                            @component('frontend.forms.language-model')
                                            @endcomponent
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="group-input">
                                            ...
                                            <div class="relative-container">
                                            <textarea name="mitigation_status_comments" class="tiny"></textarea>
                                            @component('frontend.forms.language-model')
                                            @endcomponent
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="group-input">
                                            ...
                                            <div class="relative-container">
                                            <textarea name="risk_analysis" class="tiny"></textarea>
                                            @component('frontend.forms.language-model')
                                            @endcomponent
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="group-input">
                                            ...
                                            <select multiple id="reference_record" name="refrence_record[]" id="">
                                                ...
                                                $recordValue = Helpers::getDivisionName($new->division_id) . '/RA/' . date('Y') . '/' . Helpers::recordFormat($new->record);
                                                 @endphp
                                    ...
                                    <div class="col-12">
                                        <div class="group-input">
                                            ...
                                            <div class="relative-container">
                                            <textarea name="due_date_extension" class="tiny"></textarea>
                                            @component('frontend.forms.language-model')
                                            @endcomponent
                                            </div>
                                        </div>
                        ...
                        <div id="CCForm7" class="inner-block cctabcontent">
                            <div class="inner-block-content">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="group-input">
                                            <label for="Evaluation Complete On">Evaluation Complete Comment</label>
                                            <div class="static"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="group-input">
                                            <label for="Action Plan Complete On">Action Plan Complete On</label>
                                            <div class="static"></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="group-input">
                                            <label for="Risk Analysis Completed By">Action Plan Complete Comment</label>
                                            <div class="static"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="group-input">
                                            <label for="Action Plan Approved On">Action Plan Approved Comment</label>
                                            <div class="static"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="group-input">
                                            <label for="Risk Analysis Completed By">All Actions Completed By</label>
                                            <div class="static"></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="group-input">
                                            <label for="All Actions Completed On">All Actions Completed Comment</label>
                                            <div class="static"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="group-input">
                                            <label for="Risk Analysis Completed By">Residual Risk Evaluation Completed By</label>
                                            <div class="static"></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="group-input">
                                            <label for="Residual Risk Evaluation Completed On">Residual Risk Evaluation Completed Comment</label>
                                            <div class="static"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="group-input">
                                            <label for="Risk Analysis Completed By">Cancel By</label>
                                            <div class="static"></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="group-input">
                                            <label for="Residual Risk Evaluation Completed On">Cancel On</label>
                                            <div class="static"></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="group-input">
                                            <label for="Residual Risk Evaluation Completed On">Cancel Comment</label>
                                            <div class="static"></div>
                                        </div>
                                    </div>
