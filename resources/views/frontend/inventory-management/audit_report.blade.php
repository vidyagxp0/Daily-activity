...
<body>
    ...
    <header>
        <table>
            <tr>
                <td class="w-70 head">Inventory Management Audit Trail Report</td>
                <td class="w-30">
                    <div class="logo">
        ...
        <table>
            <tr>
                <td class="w-30"><strong>Inventory Management No.</strong></td>
                <td class="w-40">{{ Helpers::getDivisionName($doc->division_id) }}/IM/{{ Helpers::year($doc->created_at) }}/{{ str_pad($doc->record, 4, '0', STR_PAD_LEFT) }}</td>
