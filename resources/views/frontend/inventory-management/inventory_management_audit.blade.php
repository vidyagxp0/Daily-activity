                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="buttons-new">
                            ...
                            <button class="button_theme1"><a class="text-white"
                                    href="{{ url('showinventory/' . $document->id) }}"> Back
                                </a>
                            </button>
                            <a class="button_theme1 text-white" href="{{ url('rcms/lims-dashboard') }}"style="margin-right: 10px"> Exit
                            </a> 
                ...
                <table>
                    ...
                    <tr>
                        ...
                        @foreach ($audit as $audits => $dataDemo)
                            ...
                            <td>
                                <div>
                                    <strong> Data Field Name :</strong><a>{{ $dataDemo->activity_type ? $dataDemo->activity_type : 'Not Applicable' }}</a>
                                </div>
