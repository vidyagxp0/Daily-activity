            ...
            $('#Product_Details').click(function(e) {
                function generateTableRow(serialNumber) {
                    ...
                    var html =
                        ...
                        '<td> <select name="product_stage[]" id=""> <option value="">-- Select --</option> <option value="1">1 <option value="2">2</option> <option value="3">3</option><option value="4">4</option> <option value="5">5</option><option value="6">6</option> <option value="6">7</option> <option value="8">8</option><option value="9">9</option><option value="Final">Final</option> </select></td>' +
                                ...
                                <div class="row">
                                                    ...
                                                    @if ($grid_data1->ReferenceDocumentName)
                                                        @foreach (unserialize($grid_data1->ReferenceDocumentName) as $key => $temps)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button type="button" class="removeBtn remove-row">
                                                                        Remove
                                                                    </button>
                                                                </td>
                                    ...
                                    <script>
                                        document.addEventListener('DOMContentLoaded', function() {
                                            ...
                                            const tableBody = document.querySelector('#ReferenceDocument_details tbody');
                                            ...
                                            tableBody.addEventListener('click', function (event) {
                                                if (event.target.classList.contains('remove-row')) {
                                                    ...
                                                    Array.from(tableBody.querySelectorAll('tr')).forEach((tr, index) => {
                                                        const serialCell = tr.querySelector('input[name="serial[]"]');
                                                        if (serialCell) {
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <script>
                                            document.addEventListener('DOMContentLoaded', function() {
                                                ...
                                                const tableBody = document.querySelector('#Product_Details_Details tbody');

                                                // Remove row functionality
                                                tableBody.addEventListener('click', function (event) {
                                                    if (event.target.classList.contains('removeBtn')) {
                                                        const row = event.target.closest('tr'); // Identify the row to remove
                                                        ...
                                                        Array.from(tableBody.querySelectorAll('tr')).forEach((tr, index) => {
                                                            const serialCell = tr.querySelector('input[name="serial[]"]');
                                                            if (serialCell) {
                                                                serialCell.value = index + 1; // Update serial numbers
                                                            }
                                                        });
                                                    }
                                                });
                                                ...
                                                <div class="file-attachment-field">
                                                    ...
                                                    <div class="add-btn">
                                                        ...
                                                        <input
                                                            ...
                                                            name="hod_attachments[]"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}
