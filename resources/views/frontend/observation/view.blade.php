                                                ...
                                                <label for="actual_end_date">Due Date</lable>
                                                    ...
                                                    <div class="calenderauditee">
                                                        ...
                                                        <input type="date"
                                                            ...
                                                            value="{{ $data->due_date }}" id="actual_end_date_checkdate"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <select name="severity_rate" id="analysisR"
                                                    ...
                                                    <option value="1"
                                                        {{ $data->severity_rate == 'Negligible' ? 'selected' : '' }}>
                                                        Negligible</option>
                                                    <option value="2"
                                                        {{ $data->severity_rate == 'Moderate' ? 'selected' : '' }}>Moderate
                                                    </option>
                                                    <option value="3"
                                                        {{ $data->severity_rate == 'Major' ? 'selected' : '' }}>Major
                                                    </option>
                                                    <option value="4"
                                                        {{ $data->severity_rate == 'Fatal' ? 'selected' : '' }}>Fatal
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <select name="occurrence" id="analysisP"
                                                    ...
                                                    <option value="3"
                                                        {{ $data->occurrence == 'Unlikely' ? 'selected' : '' }}>Unlikely
                                                    </option>
                                                    <option value="2"
                                                        {{ $data->occurrence == 'Likely' ? 'selected' : '' }}>Likely
                                                    </option>
                                                    <option value="1"
                                                        {{ $data->occurrence == 'Very Likely' ? 'selected' : '' }}>Very
                                                        Likely
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <select name="detection" id="analysisN"
                                                    ...
                                                    <option value="">Enter Your Selection Here</option>
                                                    <option value="5"
                                                        {{ $data->detection == 'Impossible' ? 'selected' : '' }}>Impossible
                                                    </option>
                                                    <option value="4"
                                                        {{ $data->detection == 'Rare' ? 'selected' : '' }}>Rare</option>
                                                    <option value="3"
                                                        {{ $data->detection == 'Unlikely' ? 'selected' : '' }}>Unlikely
                                                    </option>
                                                    <option value="2"
                                                        {{ $data->detection == 'Likely' ? 'selected' : '' }}>Likely
                                                    </option>
                                                    <option value="1"
                                                        {{ $data->detection == 'Very Likely' ? 'selected' : '' }}>Very
                                                        Likely
                                                    </option>
                                                </select>
                                            </div>
