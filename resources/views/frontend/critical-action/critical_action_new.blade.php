...
@section('container')
    ...
    <div class="form-field-head">
        ...
        <div class="division-bar">
            ...
            {{ Helpers::getDivisionName(session()->get('division')) }} / Critical Action
        </div>
    </div>
    @php
    ...
    <div id="change-control-fields">
        <div class="container-fluid">
            ...
            <form action="{{ route('critical-action-store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input"> 
                                        ...
                                        <input disabled type="text" name="record_number"
                                            value="{{ Helpers::getDivisionName(session()->get('division')) }}/CA/{{ date('Y') }}/{{ $record}}">
