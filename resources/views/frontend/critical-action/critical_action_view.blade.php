        ...
        <div class="container-fluid">
            <div class="inner-block">
                ...
                <div class="slogan">
                    ...
                    {{ Helpers::getDivisionName($data->division_id) }} / Critical Action
                </div>
            </div>
        </div>
    </div>
...
{{-- {{ dd($data->stage);}} --}}
                        <button class="button_theme1"> <a class="text-white"
                                href="{{ url('critical-action-audittrialshow', $data->id) }}"> Audit Trail </a> </button>
        ...
        <div id="change-control-fields">
            <div class="container-fluid">
                ...
                <form action="{{ route('critical-action-update', $data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div id="CCForm1" class="inner-block cctabcontent">
                            <div class="inner-block-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            <label for="Related Records">Critical Action Related Records</label>
    ...
    <div class="modal fade" id="signature-modal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ url('send-At', $data->id) }}" method="POST">
                    @csrf
                    <!-- Modal body -->
                    <div class="modal-body">
    ...
    <div class="modal fade" id="cancel-modal">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="{{ url('critical-action-cancelstage', $data->id) }}" method="POST">
                            @csrf
                            <!-- Modal body -->
                            <div class="modal-body">
                                <div class="mb-3 text-justify">
