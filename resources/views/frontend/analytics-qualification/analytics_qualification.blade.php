...
@section('container')
    ...
    <script>
        $(document).ready(function() {
            let rowIndex = 1; // Start index at 1 because the initial row uses index 0
        ...
        `;
            ...
            // Remove rows dynamically and update row indices
            ...
            // Update row numbers and index values after removal
            function updateRowNumbers() {
                $('#dynamicGrid tbody tr').each(function(index) {
                    $(this).find('td:first-child input').val(index + 1); // Update row number display
                    $(this).find('input, textarea, select').each(function() {
                        const name = $(this).attr('name');
                        if (name) {
                            const updatedName = name.replace(/\d+/, index); // Update index in names
    ...
    <div id="change-control-fields">
        <div class="container-fluid">
            ...
            @endphp
            <form id="auditform" action="{{ route('analytics.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div id="step-form">
                    ...
                    <div id="CCForm1" class="inner-block cctabcontent">
                        <div class="inner-block-content">
                            <div class="row">
                                ...
                                {{-- <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select id="select-state" placeholder="Select..." name="employee_name" required
                                            ...
                                            @foreach ($userss as $emp)
                                                <option value="{{ $emp->id }}" data-name="{{ $emp->employee_name }}"
                                                    {{ isset($users) && $users->id == $emp->id ? 'selected' : '' }}>
                                                    {{ $emp->employee_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                {{-- <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <input type="text" name="employee_id"
                                            value ="{{ isset($users) ? $users->full_employee_id : '' }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <input type="text" name="department"
                                            value ="{{ isset($users) ? Helpers::getFullDepartmentName($users->department) ?? 'NA' : '' }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <input type="text" name="designation"
                                            value ="{{ isset($users) ? $users->job_title : '' }}" id="designee"
                                            required readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="Site/Location">Site Division/Project<span
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <input type="text" id="employee_code" name="employee_id" readonly>
                                    </div>
                                </div>
    ...
    @endforeach
                                ...
                                <script>
                                    function fetchEmployeeDetails() {
                                        ...
                                        var experience = selectedOption.getAttribute('data-experience');
                ...
                <div class="group-input input-date">
                    ...
                    <div class="calenderauditee">
                        ...
                        <input disabled type="text" value="{{Helpers::getdateFormat($due_date)}}">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <table class="table table-bordered" id="dynamicGrid">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><input type="text" value="1" name="documentData[0][row]"
                                                            readonly></td>
                                                    <td><input type="text" name="documentData[0][title_of_document]"
                                                            style="border: 1px solid; height: 40px;"></td>
                                                    <td>
                                                        <div class="file-attachment-field">
                                                            <div class="file-attachment-list" id="file_0"></div>
                                                            <div class="add-btn">
                                                                <div>Add</div>
                                                                <input type="file" name="documentData[0][file][]"
                                                                    oninput="addMultipleFiles(this, 'file_0')" multiple>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <textarea name="documentData[0][remarks]"></textarea>
                                                    </td>
                                                    <td><button type="text" class="removeRowBtn">Remove</button></td>
                                                </tr>
                                            </tbody>
                                ...
                                <script>
                                    $(document).ready(function() {
                                        // Attach a single click event listener to the add button
                                        $('#attachmentgrid-table').off('click').on('click', function() {
                                        ...
                                        // Function to generate a new table row with the correct serial number
                                        function generateTableRow(serialNumber) {
                                            return `
                                                <tr>
                                                    <td><input disabled type="text" name="trainer_listOfAttachment[${serialNumber}][serial_number]" value="${serialNumber}" /></td>
                                                    <td><input type="text" name="trainer_listOfAttachment[${serialNumber}][title_of document]" /></td>
                                                    <td><input type="text" name="trainer_listOfAttachment[${serialNumber}][supporting_document]" /></td>
                                                    <td><input type="text" name="trainer_listOfAttachment[${serialNumber}][remarks]" /></td>
                                                    <td><button type="button" class="removeRowBtn">Remove</button></td>
                                                </tr>`;
                                        }

                                        // Attach a single event listener for removing rows
                                        $(document).on('click', '.removeRowBtn', function() {
                                            $(this).closest('tr').remove();
                                        });
                                    });
                        ...
                        <div class="inner-block-content">
                            ...
                            <div class="pt-2 group-input">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="job-responsibilty-table"
                                        style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th style="width: 5%;">Sr No.</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><input disabled type="text" name="jobResponsibilities[serial]"
                                                        value=""></td>
                                                <td><input type="text" name="jobResponsibilities[job]" value=""
                                                        class="question-input">
                                                </td>
                                                <td><input type="text" name="jobResponsibilities[remarks]"
                                                        value="" class="answer-input">
                                                </td>
                                                <td><input type="text" name="jobResponsibilities[comments]"
                                                        value="" class="answer-input">
                                                </td>
                                            </tr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <input type="file" id="myfile" name="qa_final_attachment" value="">
                                        <a href="" target="_blank"></a>
                                    </div>
                                </div>
