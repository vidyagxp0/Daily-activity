                ...
                <table>
                    <div class="heading">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex" style="gap:15px; margin-right: 20px;"><button type="button"> <a class="text-white" href="{{route('analytics_qualification.show', $trainer->id) }}">
                                        Back </a>
                                </button> <button type="button"> <a class="text-white" href="{{ url('rcms/lims-dashboard') }}">
                                        Exit </a> </button>
                            </div>
                        </div>
