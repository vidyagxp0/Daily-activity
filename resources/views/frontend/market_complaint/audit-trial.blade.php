            ...
            <body>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="buttons-new">
                        ...
                        <button class="button_theme1"><a class="text-white"href="{{ url('/rcms/marketcomplaint/marketcomplaint_view/' . $document->id) }}"> Back
                            </a>
                        </button>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        @foreach ($audit as $audits => $dataDemo)
                            ...
                            <td>
                                <div>
                                    <strong> Data Field Name :</strong>{{ $dataDemo->activity_type ? $dataDemo->activity_type : 'Not Applicable' }}</a>
                                </div>
