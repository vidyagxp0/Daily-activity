        ...
        <div class="row">
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <textarea class="" name="summary_of_exp_hyp_piiqcr" id="summernote-1">
            ...
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                    <textarea class="" name="summary_mfg_investigation_piiqcr" id="summernote-1">
            ...
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                    <textarea class="" name="details_of_root_cause_piiqcr" id="summernote-1">
            ...
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                    <textarea class="" name="impact_assessment_piiqcr" id="summernote-1">
                  {{$data->impact_assessment_piiqcr ? $data->impact_assessment_piiqcr : ""}}
                </textarea>
                </div>
            </div>
