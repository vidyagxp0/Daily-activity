        ...
        <div class="row">
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <textarea class="" name="conclusion_comments_oosc" id="summernote-1">
            ...
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                    <textarea class="" name="justifi_for_averaging_results_oosc" id="summernote-1">
            ...
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <textarea class="" name="justify_if_capa_not_required_oosc" id="summernote-1">
            ...
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <textarea class="" name="justification_for_delay_oosc" id="summernote-1">
