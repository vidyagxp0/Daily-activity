        ...
        <div class="row">
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <textarea class="" name="summary_of_prelim_investiga_plic"
                        id="summernote-1">
            ...
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <textarea class="" name="oos_category_others_plic" id="summernote-1"
                        value="">
            ...
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                    <textarea class="" name="root_cause_details_plic" id="summernote-1">
            ...
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <div><small class="text-primary">Please insert "NA" in the data field if it does not
                            require completion </small></div>
                    <textarea class="" name="Description_Deviation" id="summernote-1"
            ...
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                    <textarea class="" name="delay_justification_for_pi_plic"
