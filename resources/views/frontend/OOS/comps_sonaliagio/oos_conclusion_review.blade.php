        ...
        <div class="row">
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <textarea class="" name="conclusion_review_comments_ocr" id="summernote-1">
            ...
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <textarea class="" name="action_taken_on_affec_batch_ocr" id="summernote-1">
            ...
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <textarea class="" name="justify_if_no_risk_assessment_ocr" id="summernote-1">
