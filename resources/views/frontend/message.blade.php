...
<body>
    <div class="email-container">
        ...
        <div class="email-header">
            <h2>You have received a notification from VidyaGxP Digital Transformation Solutions</h2>
        </div>
        ...
        <div class="email-footer">
            <p>© {{ date('Y') }} VidyaGxP Digital Transformation Solutions. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
