                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="buttons-new">
                        ...
                        <button class="button_theme1"><a class="text-white"
                                href="{{ url('showCalibrationDetails/' . $document->id) }}"> Back
                            </a>
                        </button>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <!-- <form action="" method="POST"> -->
                                <form action="{{ route('store_audit_review_mc', $document->id) }}" method="POST">
                                    @csrf
                                    <!-- Modal body -->
                    ...
                    <table>
                        <div class="heading">
                            ...
                            <div style="margin-bottom: 5px;  font-weight: bold;"> Originator
                                :{{ Helpers::getInitiatorName($document->initiator_id ? $document->initiator_id : '') }}</div>
                            ...
                            <td>
                                <div>
                                    <strong> Data Field Name :</strong><a
                                        href="{{ url('rcms/calibrationAuditTrail',$document->id)}}">{{ $dataDemo->activity_type ? $dataDemo->activity_type : 'Not Applicable' }}</a>
                                </div>
