                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        @if(!empty($parent_id))
                                            ...
                                            <input disabled type="text" name="record_number" value="{{ Helpers::getDivisionName($parent_division_id) }}/EXT/{{ date('y') }}/{{ $record_number }}">
                                        @else
                                            <input type="hidden" name="record" value="{{ $record_number }}">
                                            <input disabled type="text" name="record_number" value="{{ Helpers::getDivisionName(session()->get('division')) }}/EXT/{{ date('y') }}/{{ $record_number }}">
                                        @endif
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        @if(!empty($parent_id))
                                            <input disabled type="text" name="site_location_code" value="{{ Helpers::getDivisionName($parent_division_id) }}">
                                            <input type="hidden" name="site_location_code" value="{{ $parent_division_id }}">
                                        @else
                                            <input disabled type="text" name="site_location_code" value="{{ Helpers::getDivisionName(session()->get('division')) }}">
