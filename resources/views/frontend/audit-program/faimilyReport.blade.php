            ...
            <div class="block">
                ...
                <div class="border-table">
                    <table>
                        ...
                        @if (!empty($AuditProgramGrid))
                         @php 
                            $auditees     =    unserialize($AuditProgramGrid->auditor);
                            $startDates   =    unserialize($AuditProgramGrid->start_date);
                            $endDates     =    unserialize($AuditProgramGrid->end_date); 
                            $leadInvestigators =  unserialize($AuditProgramGrid->lead_investigator); 
                            $comments     =      unserialize($AuditProgramGrid->comment); 
                    ...
                    <tr>
                        ...
                        <td class="w-15">{{  Helpers::getInitiatorName($auditee) ?? 'Not Applicable' }}</td>
                        <td class="w-15">{{ isset($startDates[$key]) ? \Carbon\Carbon::parse($startDates[$key])->format('d-M-Y') : 'Not Applicable' }}</td>
                        <td class="w-15">{{ isset($endDates[$key]) ? \Carbon\Carbon::parse($endDates[$key])->format('d-M-Y') : 'Not Applicable' }}</td>
                        <td class="w-15">{{  Helpers::getInitiatorName($leadInvestigators[$key]) ?? 'Not Applicable' }}</td>
                        <td class="w-15">{{ $comments[$key] ?? 'Not Applicable' }}</td>
                    </tr>
                        @endforeach
                    @else
                        <tr>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <th class="w-20">Cancel Comment</th>
                         <td class="w-80">{{ $data->cancel_1_comment }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th class="w-20">Cancel By</th>
                        <td class="w-30">{{ $data->cancel_second_by }}</td>
                        <th class="w-20">Cancel On</th>
                        <td class="w-30">{{ $data->cancel_second_on }}</td>
                        <th class="w-20">Cancel Comment</th>
                    ...
                    <tr>
                        ...
                        <th class="w-20">Audit Completed Comment</th>
                        <td class="w-80">{{ $data->Audit_Completed_comment }}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="w-30">{{ $data->cancel_third_by }}</td>
                        <th class="w-20">Cancelled On</th>
                        <td class="w-30">{{ $data->cancel_third_on }}</td>
                        <th class="w-20">Cancel Comment </th>
                        <td class="w-30">{{ $data->Reject_comment_2 }}</td>
