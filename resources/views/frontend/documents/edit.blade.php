    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-3">
            <div class="group-input">
                ...
                <select name="product_material_type">
                    ...
                    <option value="RM" {{ $document->product_material_type == 'RM' ? 'selected' : '' }}>RM</option>
                    <option value="PM" {{ $document->product_material_type == 'PM' ? 'selected' : '' }}>PM</option>
                    <option value="SPG" {{ $document->product_material_type == 'SPG' ? 'selected' : '' }}>SPG</option>
                    <option value="FG" {{ $document->product_material_type == 'FG' ? 'selected' : '' }}>FG</option>
                </select>
            </div>
        </div>
        ...
        <div class="col-lg-6 mb-3">
            <div class="group-input">
                ...
                <input type="text" name="product_material_code" value="{{ $document->product_material_code ?? '' }}">
            </div>
        </div>
        ...
        <div class="col-lg-6 mb-3">
            <div class="group-input">
                ...
                <select name="product_material_market" id="product_material_market">
                    <option value="">--Select--</option>
                    <option value="Afghanistan" {{ $document->product_material_market == 'Afghanistan' ? 'selected' : '' }}>Afghanistan</option>
                    <option value="Albania" {{ $document->product_material_market == 'Albania' ? 'selected' : '' }}>Albania</option>
                    <option value="Algeria" {{ $document->product_material_market == 'Algeria' ? 'selected' : '' }}>Algeria</option>
                    <option value="Andorra" {{ $document->product_material_market == 'Andorra' ? 'selected' : '' }}>Andorra</option>
                    <option value="Angola" {{ $document->product_material_market == 'Angola' ? 'selected' : '' }}>Angola</option>
                    <option value="Argentina" {{ $document->product_material_market == 'Argentina' ? 'selected' : '' }}>Argentina</option>
                    <option value="Australia" {{ $document->product_material_market == 'Australia' ? 'selected' : '' }}>Australia</option>
                    <option value="Austria" {{ $document->product_material_market == 'Austria' ? 'selected' : '' }}>Austria</option>
                    <option value="Belgium" {{ $document->product_material_market == 'Belgium' ? 'selected' : '' }}>Belgium</option>
                    <option value="Brazil" {{ $document->product_material_market == 'Brazil' ? 'selected' : '' }}>Brazil</option>
                    <option value="Canada" {{ $document->product_material_market == 'Canada' ? 'selected' : '' }}>Canada</option>
                    <option value="China" {{ $document->product_material_market == 'China' ? 'selected' : '' }}>China</option>
                    <option value="Denmark" {{ $document->product_material_market == 'Denmark' ? 'selected' : '' }}>Denmark</option>
                    <option value="Egypt" {{ $document->product_material_market == 'Egypt' ? 'selected' : '' }}>Egypt</option>
                    <option value="France" {{ $document->product_material_market == 'France' ? 'selected' : '' }}>France</option>
                    <option value="Germany" {{ $document->product_material_market == 'Germany' ? 'selected' : '' }}>Germany</option>
                    <option value="India" {{ $document->product_material_market == 'India' ? 'selected' : '' }}>India</option>
                    <option value="Italy" {{ $document->product_material_market == 'Italy' ? 'selected' : '' }}>Italy</option>
                    <option value="Japan" {{ $document->product_material_market == 'Japan' ? 'selected' : '' }}>Japan</option>
                    <option value="Kenya" {{ $document->product_material_market == 'Kenya' ? 'selected' : '' }}>Kenya</option>
                    <option value="Kuwait" {{ $document->product_material_market == 'Kuwait' ? 'selected' : '' }}>Kuwait</option>
                    <option value="Malaysia" {{ $document->product_material_market == 'Malaysia' ? 'selected' : '' }}>Malaysia</option>
                    <option value="Mexico" {{ $document->product_material_market == 'Mexico' ? 'selected' : '' }}>Mexico</option>
                    <option value="Nigeria" {{ $document->product_material_market == 'Nigeria' ? 'selected' : '' }}>Nigeria</option>
                    <option value="Norway" {{ $document->product_material_market == 'Norway' ? 'selected' : '' }}>Norway</option>
                    <option value="Pakistan" {{ $document->product_material_market == 'Pakistan' ? 'selected' : '' }}>Pakistan</option>
                    <option value="Poland" {{ $document->product_material_market == 'Poland' ? 'selected' : '' }}>Poland</option>
                    <option value="Portugal" {{ $document->product_material_market == 'Portugal' ? 'selected' : '' }}>Portugal</option>
                    <option value="Qatar" {{ $document->product_material_market == 'Qatar' ? 'selected' : '' }}>Qatar</option>
                    <option value="Russia" {{ $document->product_material_market == 'Russia' ? 'selected' : '' }}>Russia</option>
                    <option value="Saudi Arabia" {{ $document->product_material_market == 'Saudi Arabia' ? 'selected' : '' }}>Saudi Arabia</option>
                    <option value="South Africa" {{ $document->product_material_market == 'South Africa' ? 'selected' : '' }}>South Africa</option>
                    <option value="South Korea" {{ $document->product_material_market == 'South Korea' ? 'selected' : '' }}>South Korea</option>
                    <option value="Spain" {{ $document->product_material_market == 'Spain' ? 'selected' : '' }}>Spain</option>
                    <option value="Sweden" {{ $document->product_material_market == 'Sweden' ? 'selected' : '' }}>Sweden</option>
                    <option value="Switzerland" {{ $document->product_material_market == 'Switzerland' ? 'selected' : '' }}>Switzerland</option>
                    <option value="United Arab Emirates" {{ $document->product_material_market == 'United Arab Emirates' ? 'selected' : '' }}>United Arab Emirates</option>
                    <option value="United Kingdom" {{ $document->product_material_market == 'United Kingdom' ? 'selected' : '' }}>United Kingdom</option>
                    <option value="United States" {{ $document->product_material_market == 'United States' ? 'selected' : '' }}>United States</option>
                    <option value="Vietnam" {{ $document->product_material_market == 'Vietnam' ? 'selected' : '' }}>Vietnam</option>
                </select>
            </div>
        </div>
