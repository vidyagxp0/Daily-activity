            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="UserId" class="form-control" value="{{ $data->UserId }}"
                        id="exampleInputName1" placeholder="Enter User ID" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="name" name="name" class="form-control" value="{{ $data->name }}"
                        id="exampleInputName1" placeholder="Enter Name" required>
                </div>

                <div class="form-group">
                    <label for="exampleInputName1">Mobile Number*</label>
                    <input type="text" name="mobile_number" class="form-control" value="{{ $data->mobile_number }}"
                        id="exampleInputName1" placeholder="Enter Mobile Number" required>
                </div>
