        ...
        <form action="{{ route('user_management.store') }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="UserId" class="form-control @error('UserId') is-invalid @enderror" id="UserId" placeholder="User ID" required>
                    @error('UserId')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="Username" class="form-control @error('Username') is-invalid @enderror" id="Username" placeholder="Enter User Name" required>
                    @error('Username')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="name" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Enter Name" required>
                    @error('name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="mobile_number" class="form-control @error('mobile_number') is-invalid @enderror" id="mobile_number" placeholder="Enter Mobile Number" required>
                    @error('mobile_number')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
